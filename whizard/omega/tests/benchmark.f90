...
program benchmark
  ...
  use kinds
  use constants
  use amplitude_benchmark_v1, only: new_event_v1 => new_event, &
       number_particles_in, number_particles_out
  use amplitude_benchmark_v2, only: new_event_v2 => new_event
  use amplitude_benchmark_v3, only: new_event_v3 => new_event
! use amplitude_benchmark_v4, only: new_event_v4 => new_event
