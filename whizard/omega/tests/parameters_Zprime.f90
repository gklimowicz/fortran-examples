...
contains
  ...
  subroutine init_parameters
    real(default), dimension(40) :: vars
    ...
    vars(6)  = 0.0005109997 ! electron mass
    ...
    vars(14) = 1200         ! Z-boson mass
    vars(15) = 2.443        ! Z-boson width
    vars(16) = 2.049        ! W-boson width
    vars(17) = 100          ! Z-heavy width
    vars(18) = 0.004143     ! Higgs width
    vars(19) = 1.0          ! Multiply the Z lepton V coupling
    vars(20) = 1.0          ! Multiply the Z neutrino V coupling
    vars(21) = 1.0          ! Multiply the Z up V coupling
    vars(22) = 1.0          ! Multiply the Z down V coupling
    vars(23) = 1.0          ! Multiply the Z lepton A coupling
    vars(24) = 1.0          ! Multiply the Z neutrino A coupling
    vars(25) = 1.0          ! Multiply the Z up A coupling
    vars(26) = 1.0          ! Multiply the Z down A coupling
    vars(27) = 0.1          ! Explicit ZH lepton V coupling
    vars(28) = 0.2          ! Explicit ZH neutrino V coupling
    vars(29) = 0.3          ! Explicit ZH up V coupling
    vars(30) = 0.4          ! Explicit ZH down V coupling
    vars(31) = 0.5          ! Explicit ZH lepton A coupling
    vars(32) = 0.6          ! Explicit ZH neutrino A coupling
    vars(33) = 0.7          ! Explicit ZH up A coupling
    vars(34) = 0.8          ! Explicit ZH down A coupling
    vars(35) = 0.9          ! Sequential ZH coupling to hypercharge
    vars(36) = 1.0          ! Sequential ZH coupling to B-L
    vars(37) = 1 / sqrt (sqrt (two) * vars(1))     ! v (Higgs vev)
    vars(38) = vars(3) / vars(2)                   ! cos(theta-W)
    vars(39) = sqrt (1-vars(38)**2)                ! sin(theta-W)
    vars(40) = 2 * vars(39) * vars(3) / vars(37)   ! em-coupling (GF scheme)
