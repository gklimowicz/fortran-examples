...
* Usage
To get all these example Fortran projects, on a case-sensitive file system, execute
...
To update after changes from each repository's origin:
#+begin_src
git pull
...
| text73           | The number of lines in fixed-form with text in columns 73-80   |
| text133          | The number of lines in fixed-form with text in columns 133-140 |
