...
C      rite(flnmout,'(3a,i3,a)') 'mon_ov_',trim(runid),'_',dcd,'.tbin'
C      pen(301,file=flnmout,form='unformatted',status='unknown')
      write(flnmout,'(5a)') 'mon_hf_',trim(runid),'_',ayears,'.tbin'
      open(302,file=trim(path2)//flnmout,				&
           form='unformatted',status='unknown')
      write(*,'(a,/,a)') 'Open file for writing:',trim(flnmout) 

C      rite(flnmout,'(3a,i3,a)') 'mon_hf_',trim(runid),'_',dcd,'.tbin'
C      pen(302,file=flnmout,form='unformatted',status='unknown')
c
      do 151 ny=ny1,ny2
      do 152 mo=mo1,mo2
c      rite(flnm,'(5a,i3,a,i3,2a,i4.4,2a)')trim(path1),trim(runid)
...
c      rite(lp,'(a,i4,f6.2,a,i2,a,2f6.1)') 
...
c
c      rite(*,'(a,27f4.0)') 'sunda=',(sunda(k),k=1,kdm+1)
c      rite(*,'(a,26f4.0)') 'Indo_pa=',(flux(indoi,k,3),k=1,kdm)
c      rite(*,'(a,26f4.0)') 'Indo_in=',(flux(indoi,k,2),k=1,kdm)
...
c      rite(*,'(a,26f4.0)') 'pa flux=',(flux(indoi,k,3),k=1,kdm)
c      rite(*,'(a,26f4.0)') 'in flux=',(flux(indoi,k,2),k=1,kdm)
c
c      o l=1,4
c      rite(301,'(387f6.1)') ((flux(i,k,l),i=1,idm),k=1,kdm)
c      nd do
c      o i=1,idm
c      rite(302,'(i3,f6.1,8f8.2)') i,lat(i),(heatfl(i,k),k=1,4)
c      nd do
