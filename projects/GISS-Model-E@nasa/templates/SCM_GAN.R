SCM_GAN_M.R GISS Model E      M. Kelley 10/2013, A. Wolf 11/2016
...
! SCM input files
SCM_NML=SCM_GAN.nml                                           ! input variable namelist with units
SCM_PS=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf      ! surface pressure
SCM_SFLUX=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf   ! surface heat fluxes
SCM_TSKIN=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf   ! skin temperature
! if horizontal and geostrophic wind profiles are specified, horizontal are initial
SCM_WIND=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf    ! horizontal wind profiles
!SCM_GEO=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf    ! geostrophic wind profiles
SCM_TEMP=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf    ! temperature profile(s)
SCM_WVMR=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf    ! water vapor mixing ratio profile(s)
SCM_OMEGA=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf   ! large-scale vertical wind
!SCM_LS_V=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf   ! large-scale vert adv flux div profile(s)
SCM_LS_H=gan180varanaecmwfanatrmmC1.c1.20111002.000000.cdf    ! large-scale horiz adv flux div profile(s)
...
! SCM parameters
SCM_lon=73.1               ! GAN Island Maldives (deg)
SCM_lat=-0.63              ! GAN Island Maldives (deg)
...
SUBDD='u v t q rh z p_3d p_surf prec mcp ssp qcl qci'
SUBDD1='cldss cldmc cldss_2d totcld totcld_diag'
SUBDD2='gtempr gtemp tsavg shflx lhflx ustar pblht pwv lwp iwp tau_ss tau_mc'
...
&&END_PARAMETERS
 ...
 &INPUTZ
 YEARI=2011,MONTHI=10,DATEI=02,HOURI=0, ! pick IYEAR1=YEARI (default) or < YEARI
 YEARE=2011,MONTHE=12,DATEE=31,HOURE=21,     KDIAG=12*0,9,
 ISTART=2,IRANDI=0, YEARE=2011,MONTHE=10,DATEE=5,HOURE=0,
/
