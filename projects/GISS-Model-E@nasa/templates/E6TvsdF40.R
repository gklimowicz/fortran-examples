E6TvsdF40.R GISS ModelE Lat-Lon Atmosphere Model, 1850 atm./ocean with VSD tracers
...
!PNETCDF currently doesnt work with VSD tracers:
...
src_dist_cfg=/discover/nobackup/mkelley5/bfuncs/xyztr144_144x90.nc !VSD tracer spatial distribution

Label and Namelist:  (next 2 lines)
E6TvsdF40 (prescribed ocean atmospheric tracer model with VSD water tracers only) 
...
src_dist_tr='Water' ! indicate that tracers are tracking water
