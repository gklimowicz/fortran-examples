E1M20dv.R GISS Model E  2004 modelE                 rar 12/01/03

E1M20dv: rundeck for running GCM coupled to Dynamic Vegatation (Ent).
...
Label and Namelist:
E1M20dv (ModelE1 4x5, 20 lyrs, 1880 atm/ocn; use up to 72 (or 80) columns and ??
