E4TctomasiF40ncep.R GISS Model E  1850 ocn/atm   jan perlwitz  07/2009

E4TctomasiF40ncep:  E4TctomasiF40 nudged with NCEP 
...
#define NUDGE_ON                 ! nudge the meteorology
!  OFF !define MERRA_NUDGING            ! nudging to use
...
&&PARAMETERS
!---- for nudging:
ANUDGEU=0.001d0  ! the met nudging  ! 1/10 of defaults
ANUDGEV=0.001d0  ! relaxation times ! 1/10 of defaults
...
&&END_PARAMETERS
 ...
 IYEAR1=1950 ! Need to read MERRA nudging file
/
