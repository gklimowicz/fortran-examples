...
module parameters_sm_higgs_recola
  use kinds
  use constants
  ...
  complex(default), public :: qlep, qup, qdwn, gcc, qw, &
       ...
       ghbb, ghtt, ghcc, ghtautau, gh3, gh4, ghmm, ghee, &
       ghgaga, ghgaz, ghgg, &
...
! Recola defaults:
    mass = 0
    width = 0
    mass(6)   = 173.1_default               ! top
    mass(23)  =  91.153480619183_default    ! Z
    width(23) =   2.4942663787728_default
    mass(24)  =  80.357973609878_default    ! W
    width(24) =   2.0842989982782_default
    mass(25)  = 125                         ! H
    ! mass(11)    = 0.000510997_default  ! electron mass
    mass(13)    = 0.105658389_default  ! muon mass
...
end module parameters_sm_higgs_recola
