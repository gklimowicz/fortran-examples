...
module parameters_sm_from_ufo
  ...
  ! Declare this parameter in case te UFO model does not provide
  ! it (use parameters_sm_from_ufo will shadow it, if appropriate.)
  real(default) :: cabi
...
contains
  ...
  subroutine init_parameters
    ...
    use parameters_sm_ufo

    unit = 1.0_default

    ! Switch off the mixing of the first two generations
    cabi = 0

    ! Switch off the first two generation masses and Yukawas
    MD = 0
    ymdo = 0
    MU = 0
    ymup = 0
    ...
    ! import the parameters from UFO
    mass(1:27)  = 0
    width(1:27) = 0
    mass(1)     = MD
    mass(2)     = MU
...
end module parameters_sm_from_ufo
