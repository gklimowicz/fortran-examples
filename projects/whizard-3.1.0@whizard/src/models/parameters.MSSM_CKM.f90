...
contains
  subroutine import_from_whizard (par_array, scheme)
    ...
    par%vckm11 = par_array(132)
    par%vckm12 = par_array(133)
    par%vckm13 = par_array(134)
    par%vckm21 = par_array(135)
    par%vckm22 = par_array(136)
    par%vckm23 = par_array(137)
    par%vckm31 = par_array(138)
    par%vckm32 = par_array(139)
    par%vckm33 = par_array(140)
    par%v      = par_array(141)
    par%cw     = par_array(142)
    par%sw     = par_array(143)
    par%ee     = par_array(144)
    mass(1:70) = 0
    width(1:70) = 0
    mass(3) = par%ms
    mass(4) = par%mc
...
contains
 subroutine setup_parameters1 ()
    ...
    igs = (imago * gs)
    ! vev = ((2.0_default * mass(24)) / g)   *** This is predefined! *** 
    q_lep  = (- 1.0_default) 
...
end module parameters_mssm_ckm
