...
!  AccumOp values
INTEGER(GLenum), PARAMETER :: GL_ACCUM                 = int(z'0100', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LOAD                  = int(z'0101', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RETURN                = int(z'0102', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MULT                  = int(z'0103', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ADD                   = int(z'0104', kind=GLenum)
!  AlphaFunction values
INTEGER(GLenum), PARAMETER :: GL_NEVER                 = int(z'0200', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LESS                  = int(z'0201', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EQUAL                 = int(z'0202', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LEQUAL                = int(z'0203', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_GREATER               = int(z'0204', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NOTEQUAL              = int(z'0205', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_GEQUAL                = int(z'0206', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALWAYS                = int(z'0207', kind=GLenum)
!  AttribMask values
INTEGER(GLbitfield), PARAMETER :: GL_CURRENT_BIT           = int(z'00000001', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_POINT_BIT             = int(z'00000002', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_LINE_BIT              = int(z'00000004', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_POLYGON_BIT           = int(z'00000008', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_POLYGON_STIPPLE_BIT   = int(z'00000010', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_PIXEL_MODE_BIT        = int(z'00000020', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_LIGHTING_BIT          = int(z'00000040', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_FOG_BIT               = int(z'00000080', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_DEPTH_BUFFER_BIT      = int(z'00000100', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_ACCUM_BUFFER_BIT      = int(z'00000200', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_STENCIL_BUFFER_BIT    = int(z'00000400', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_VIEWPORT_BIT          = int(z'00000800', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_TRANSFORM_BIT         = int(z'00001000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_ENABLE_BIT            = int(z'00002000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_COLOR_BUFFER_BIT      = int(z'00004000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_HINT_BIT              = int(z'00008000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_EVAL_BIT              = int(z'00010000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_LIST_BIT              = int(z'00020000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_TEXTURE_BIT           = int(z'00040000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_SCISSOR_BIT           = int(z'00080000', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_ALL_ATTRIB_BITS       = int(z'000fffff', kind=GLbitfield)
!  BeginMode values
INTEGER(GLenum), PARAMETER :: GL_POINTS                = int(z'0000', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINES                 = int(z'0001', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_LOOP             = int(z'0002', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_STRIP            = int(z'0003', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TRIANGLES             = int(z'0004', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TRIANGLE_STRIP        = int(z'0005', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TRIANGLE_FAN          = int(z'0006', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_QUADS                 = int(z'0007', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_QUAD_STRIP            = int(z'0008', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON               = int(z'0009', kind=GLenum)
!  BlendEquationMode values
!  BlendingFactorDest values
INTEGER(GLenum), PARAMETER :: GL_ZERO                  = 0 ! 0
INTEGER(GLenum), PARAMETER :: GL_ONE                   = 1 ! 1
INTEGER(GLenum), PARAMETER :: GL_SRC_COLOR             = int(z'0300', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_SRC_COLOR   = int(z'0301', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SRC_ALPHA             = int(z'0302', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_SRC_ALPHA   = int(z'0303', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DST_ALPHA             = int(z'0304', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_DST_ALPHA   = int(z'0305', kind=GLenum)
!  BlendingFactorSrc values
INTEGER(GLenum), PARAMETER :: GL_DST_COLOR             = int(z'0306', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_DST_COLOR   = int(z'0307', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SRC_ALPHA_SATURATE    = int(z'0308', kind=GLenum)
!  Boolean values
...
INTEGER(GLenum), PARAMETER :: GL_CLIP_PLANE0           = int(z'3000', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CLIP_PLANE1           = int(z'3001', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CLIP_PLANE2           = int(z'3002', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CLIP_PLANE3           = int(z'3003', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CLIP_PLANE4           = int(z'3004', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CLIP_PLANE5           = int(z'3005', kind=GLenum)
...
!  CullFaceMode values
!  DataType values
INTEGER(GLenum), PARAMETER :: GL_BYTE                  = int(z'1400', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_BYTE         = int(z'1401', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SHORT                 = int(z'1402', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_SHORT        = int(z'1403', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INT                   = int(z'1404', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_INT          = int(z'1405', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FLOAT                 = int(z'1406', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_2_BYTES               = int(z'1407', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_3_BYTES               = int(z'1408', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_4_BYTES               = int(z'1409', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DOUBLE                = int(z'140A', kind=GLenum)
!  DepthFunction values
!  DrawBufferMode values
INTEGER(GLenum), PARAMETER :: GL_NONE                  = 0 ! 0
INTEGER(GLenum), PARAMETER :: GL_FRONT_LEFT            = int(z'0400', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FRONT_RIGHT           = int(z'0401', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BACK_LEFT             = int(z'0402', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BACK_RIGHT            = int(z'0403', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FRONT                 = int(z'0404', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BACK                  = int(z'0405', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LEFT                  = int(z'0406', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RIGHT                 = int(z'0407', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FRONT_AND_BACK        = int(z'0408', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AUX0                  = int(z'0409', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AUX1                  = int(z'040A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AUX2                  = int(z'040B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AUX3                  = int(z'040C', kind=GLenum)
!  Enable values
!  ErrorCode values
INTEGER(GLenum), PARAMETER :: GL_NO_ERROR              = 0 ! 0
INTEGER(GLenum), PARAMETER :: GL_INVALID_ENUM          = int(z'0500', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INVALID_VALUE         = int(z'0501', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INVALID_OPERATION     = int(z'0502', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STACK_OVERFLOW        = int(z'0503', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STACK_UNDERFLOW       = int(z'0504', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OUT_OF_MEMORY         = int(z'0505', kind=GLenum)
!  FeedBackMode values
INTEGER(GLenum), PARAMETER :: GL_2D                    = int(z'0600', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_3D                    = int(z'0601', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_3D_COLOR              = int(z'0602', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_3D_COLOR_TEXTURE      = int(z'0603', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_4D_COLOR_TEXTURE      = int(z'0604', kind=GLenum)
!  FeedBackToken values
REAL(GLfloat), PARAMETER :: GL_PASS_THROUGH_TOKEN    = transfer(1792,1.0)
REAL(GLfloat), PARAMETER :: GL_POINT_TOKEN           = transfer(1793,1.0)
REAL(GLfloat), PARAMETER :: GL_LINE_TOKEN            = transfer(1794,1.0)
REAL(GLfloat), PARAMETER :: GL_POLYGON_TOKEN         = transfer(1795,1.0)
REAL(GLfloat), PARAMETER :: GL_BITMAP_TOKEN          = transfer(1796,1.0)
REAL(GLfloat), PARAMETER :: GL_DRAW_PIXEL_TOKEN      = transfer(1797,1.0)
REAL(GLfloat), PARAMETER :: GL_COPY_PIXEL_TOKEN      = transfer(1798,1.0)
REAL(GLfloat), PARAMETER :: GL_LINE_RESET_TOKEN      = transfer(1799,1.0)
!  FogMode values
INTEGER(GLenum), PARAMETER :: GL_EXP                   = int(z'0800', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EXP2                  = int(z'0801', kind=GLenum)
!  FogParameter values
!  FrontFaceDirection values
INTEGER(GLenum), PARAMETER :: GL_CW                    = int(z'0900', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CCW                   = int(z'0901', kind=GLenum)
!  GetColorTableParameterPName values
!  GetConvolutionParameterPName values
!  GetHistogramParameterPName values
!  GetMapTarget values
INTEGER(GLenum), PARAMETER :: GL_COEFF                 = int(z'0A00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ORDER                 = int(z'0A01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DOMAIN                = int(z'0A02', kind=GLenum)
!  GetMinmaxParameterPName values
!  GetPixelMap values
!  GetPointerTarget values
!  GetTarget values
INTEGER(GLenum), PARAMETER :: GL_CURRENT_COLOR         = int(z'0B00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_INDEX         = int(z'0B01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_NORMAL        = int(z'0B02', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_TEXTURE_COORDS = int(z'0B03', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_RASTER_COLOR  = int(z'0B04', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_RASTER_INDEX  = int(z'0B05', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_RASTER_TEXTURE_COORDS = int(z'0B06', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_RASTER_POSITION = int(z'0B07', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_RASTER_POSITION_VALID = int(z'0B08', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CURRENT_RASTER_DISTANCE = int(z'0B09', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POINT_SMOOTH          = int(z'0B10', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POINT_SIZE            = int(z'0B11', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POINT_SIZE_RANGE      = int(z'0B12', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POINT_SIZE_GRANULARITY = int(z'0B13', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_SMOOTH           = int(z'0B20', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_WIDTH            = int(z'0B21', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_WIDTH_RANGE      = int(z'0B22', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_WIDTH_GRANULARITY = int(z'0B23', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_STIPPLE          = int(z'0B24', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_STIPPLE_PATTERN  = int(z'0B25', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_STIPPLE_REPEAT   = int(z'0B26', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIST_MODE             = int(z'0B30', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_LIST_NESTING      = int(z'0B31', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIST_BASE             = int(z'0B32', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIST_INDEX            = int(z'0B33', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_MODE          = int(z'0B40', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_SMOOTH        = int(z'0B41', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_STIPPLE       = int(z'0B42', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EDGE_FLAG             = int(z'0B43', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CULL_FACE             = int(z'0B44', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CULL_FACE_MODE        = int(z'0B45', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FRONT_FACE            = int(z'0B46', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHTING              = int(z'0B50', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT_MODEL_LOCAL_VIEWER = int(z'0B51', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT_MODEL_TWO_SIDE  = int(z'0B52', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT_MODEL_AMBIENT   = int(z'0B53', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SHADE_MODEL           = int(z'0B54', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_MATERIAL_FACE   = int(z'0B55', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_MATERIAL_PARAMETER = int(z'0B56', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_MATERIAL        = int(z'0B57', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG                   = int(z'0B60', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG_INDEX             = int(z'0B61', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG_DENSITY           = int(z'0B62', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG_START             = int(z'0B63', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG_END               = int(z'0B64', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG_MODE              = int(z'0B65', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG_COLOR             = int(z'0B66', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_RANGE           = int(z'0B70', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_TEST            = int(z'0B71', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_WRITEMASK       = int(z'0B72', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_CLEAR_VALUE     = int(z'0B73', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_FUNC            = int(z'0B74', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ACCUM_CLEAR_VALUE     = int(z'0B80', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_TEST          = int(z'0B90', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_CLEAR_VALUE   = int(z'0B91', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_FUNC          = int(z'0B92', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_VALUE_MASK    = int(z'0B93', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_FAIL          = int(z'0B94', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_PASS_DEPTH_FAIL = int(z'0B95', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_PASS_DEPTH_PASS = int(z'0B96', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_REF           = int(z'0B97', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_WRITEMASK     = int(z'0B98', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MATRIX_MODE           = int(z'0BA0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NORMALIZE             = int(z'0BA1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_VIEWPORT              = int(z'0BA2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MODELVIEW_STACK_DEPTH = int(z'0BA3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROJECTION_STACK_DEPTH = int(z'0BA4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_STACK_DEPTH   = int(z'0BA5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MODELVIEW_MATRIX      = int(z'0BA6', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROJECTION_MATRIX     = int(z'0BA7', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_MATRIX        = int(z'0BA8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ATTRIB_STACK_DEPTH    = int(z'0BB0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CLIENT_ATTRIB_STACK_DEPTH = int(z'0BB1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA_TEST            = int(z'0BC0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA_TEST_FUNC       = int(z'0BC1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA_TEST_REF        = int(z'0BC2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DITHER                = int(z'0BD0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLEND_DST             = int(z'0BE0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLEND_SRC             = int(z'0BE1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLEND                 = int(z'0BE2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LOGIC_OP_MODE         = int(z'0BF0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_LOGIC_OP        = int(z'0BF1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_LOGIC_OP        = int(z'0BF2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AUX_BUFFERS           = int(z'0C00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DRAW_BUFFER           = int(z'0C01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_READ_BUFFER           = int(z'0C02', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SCISSOR_BOX           = int(z'0C10', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SCISSOR_TEST          = int(z'0C11', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_CLEAR_VALUE     = int(z'0C20', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_WRITEMASK       = int(z'0C21', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_CLEAR_VALUE     = int(z'0C22', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_WRITEMASK       = int(z'0C23', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_MODE            = int(z'0C30', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGBA_MODE             = int(z'0C31', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DOUBLEBUFFER          = int(z'0C32', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STEREO                = int(z'0C33', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RENDER_MODE           = int(z'0C40', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PERSPECTIVE_CORRECTION_HINT = int(z'0C50', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POINT_SMOOTH_HINT     = int(z'0C51', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE_SMOOTH_HINT      = int(z'0C52', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_SMOOTH_HINT   = int(z'0C53', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FOG_HINT              = int(z'0C54', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_GEN_S         = int(z'0C60', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_GEN_T         = int(z'0C61', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_GEN_R         = int(z'0C62', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_GEN_Q         = int(z'0C63', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_I      = int(z'0C70', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_S_TO_S      = int(z'0C71', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_R      = int(z'0C72', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_G      = int(z'0C73', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_B      = int(z'0C74', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_A      = int(z'0C75', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_R_TO_R      = int(z'0C76', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_G_TO_G      = int(z'0C77', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_B_TO_B      = int(z'0C78', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_A_TO_A      = int(z'0C79', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_I_SIZE = int(z'0CB0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_S_TO_S_SIZE = int(z'0CB1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_R_SIZE = int(z'0CB2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_G_SIZE = int(z'0CB3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_B_SIZE = int(z'0CB4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_I_TO_A_SIZE = int(z'0CB5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_R_TO_R_SIZE = int(z'0CB6', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_G_TO_G_SIZE = int(z'0CB7', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_B_TO_B_SIZE = int(z'0CB8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PIXEL_MAP_A_TO_A_SIZE = int(z'0CB9', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_SWAP_BYTES     = int(z'0CF0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_LSB_FIRST      = int(z'0CF1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_ROW_LENGTH     = int(z'0CF2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_SKIP_ROWS      = int(z'0CF3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_SKIP_PIXELS    = int(z'0CF4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_ALIGNMENT      = int(z'0CF5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PACK_SWAP_BYTES       = int(z'0D00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PACK_LSB_FIRST        = int(z'0D01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PACK_ROW_LENGTH       = int(z'0D02', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PACK_SKIP_ROWS        = int(z'0D03', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PACK_SKIP_PIXELS      = int(z'0D04', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PACK_ALIGNMENT        = int(z'0D05', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP_COLOR             = int(z'0D10', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP_STENCIL           = int(z'0D11', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_SHIFT           = int(z'0D12', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_OFFSET          = int(z'0D13', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RED_SCALE             = int(z'0D14', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RED_BIAS              = int(z'0D15', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ZOOM_X                = int(z'0D16', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ZOOM_Y                = int(z'0D17', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_GREEN_SCALE           = int(z'0D18', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_GREEN_BIAS            = int(z'0D19', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLUE_SCALE            = int(z'0D1A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLUE_BIAS             = int(z'0D1B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA_SCALE           = int(z'0D1C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA_BIAS            = int(z'0D1D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_SCALE           = int(z'0D1E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_BIAS            = int(z'0D1F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_EVAL_ORDER        = int(z'0D30', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_LIGHTS            = int(z'0D31', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_CLIP_PLANES       = int(z'0D32', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_TEXTURE_SIZE      = int(z'0D33', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_PIXEL_MAP_TABLE   = int(z'0D34', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_ATTRIB_STACK_DEPTH = int(z'0D35', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_MODELVIEW_STACK_DEPTH = int(z'0D36', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_NAME_STACK_DEPTH  = int(z'0D37', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_PROJECTION_STACK_DEPTH = int(z'0D38', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_TEXTURE_STACK_DEPTH = int(z'0D39', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_VIEWPORT_DIMS     = int(z'0D3A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_CLIENT_ATTRIB_STACK_DEPTH = int(z'0D3B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SUBPIXEL_BITS         = int(z'0D50', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_BITS            = int(z'0D51', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RED_BITS              = int(z'0D52', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_GREEN_BITS            = int(z'0D53', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLUE_BITS             = int(z'0D54', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA_BITS            = int(z'0D55', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_BITS            = int(z'0D56', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_BITS          = int(z'0D57', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ACCUM_RED_BITS        = int(z'0D58', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ACCUM_GREEN_BITS      = int(z'0D59', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ACCUM_BLUE_BITS       = int(z'0D5A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ACCUM_ALPHA_BITS      = int(z'0D5B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NAME_STACK_DEPTH      = int(z'0D70', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AUTO_NORMAL           = int(z'0D80', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_COLOR_4          = int(z'0D90', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_INDEX            = int(z'0D91', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_NORMAL           = int(z'0D92', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_TEXTURE_COORD_1  = int(z'0D93', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_TEXTURE_COORD_2  = int(z'0D94', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_TEXTURE_COORD_3  = int(z'0D95', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_TEXTURE_COORD_4  = int(z'0D96', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_VERTEX_3         = int(z'0D97', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_VERTEX_4         = int(z'0D98', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_COLOR_4          = int(z'0DB0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_INDEX            = int(z'0DB1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_NORMAL           = int(z'0DB2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_TEXTURE_COORD_1  = int(z'0DB3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_TEXTURE_COORD_2  = int(z'0DB4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_TEXTURE_COORD_3  = int(z'0DB5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_TEXTURE_COORD_4  = int(z'0DB6', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_VERTEX_3         = int(z'0DB7', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_VERTEX_4         = int(z'0DB8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_GRID_DOMAIN      = int(z'0DD0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP1_GRID_SEGMENTS    = int(z'0DD1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_GRID_DOMAIN      = int(z'0DD2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAP2_GRID_SEGMENTS    = int(z'0DD3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_1D            = int(z'0DE0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_2D            = int(z'0DE1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FEEDBACK_BUFFER_POINTER = int(z'0DF0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FEEDBACK_BUFFER_SIZE  = int(z'0DF1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FEEDBACK_BUFFER_TYPE  = int(z'0DF2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SELECTION_BUFFER_POINTER = int(z'0DF3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SELECTION_BUFFER_SIZE = int(z'0DF4', kind=GLenum)
!  GetTextureParameter values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_WIDTH         = int(z'1000', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_HEIGHT        = int(z'1001', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_INTERNAL_FORMAT = int(z'1003', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_BORDER_COLOR  = int(z'1004', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_BORDER        = int(z'1005', kind=GLenum)
!  HintMode values
INTEGER(GLenum), PARAMETER :: GL_DONT_CARE             = int(z'1100', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FASTEST               = int(z'1101', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NICEST                = int(z'1102', kind=GLenum)
!  HintTarget values
...
!  LightName values
INTEGER(GLenum), PARAMETER :: GL_LIGHT0                = int(z'4000', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT1                = int(z'4001', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT2                = int(z'4002', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT3                = int(z'4003', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT4                = int(z'4004', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT5                = int(z'4005', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT6                = int(z'4006', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LIGHT7                = int(z'4007', kind=GLenum)
!  LightParameter values
INTEGER(GLenum), PARAMETER :: GL_AMBIENT               = int(z'1200', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DIFFUSE               = int(z'1201', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SPECULAR              = int(z'1202', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POSITION              = int(z'1203', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SPOT_DIRECTION        = int(z'1204', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SPOT_EXPONENT         = int(z'1205', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SPOT_CUTOFF           = int(z'1206', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONSTANT_ATTENUATION  = int(z'1207', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINEAR_ATTENUATION    = int(z'1208', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_QUADRATIC_ATTENUATION = int(z'1209', kind=GLenum)
!  InterleavedArrays values
!  ListMode values
INTEGER(GLenum), PARAMETER :: GL_COMPILE               = int(z'1300', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COMPILE_AND_EXECUTE   = int(z'1301', kind=GLenum)
!  ListNameType values
!  LogicOp values
INTEGER(GLenum), PARAMETER :: GL_CLEAR                 = int(z'1500', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AND                   = int(z'1501', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AND_REVERSE           = int(z'1502', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COPY                  = int(z'1503', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AND_INVERTED          = int(z'1504', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NOOP                  = int(z'1505', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_XOR                   = int(z'1506', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OR                    = int(z'1507', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NOR                   = int(z'1508', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EQUIV                 = int(z'1509', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INVERT                = int(z'150A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OR_REVERSE            = int(z'150B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COPY_INVERTED         = int(z'150C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OR_INVERTED           = int(z'150D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NAND                  = int(z'150E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SET                   = int(z'150F', kind=GLenum)
!  MapTarget values
!  MaterialFace values
!  MaterialParameter values
INTEGER(GLenum), PARAMETER :: GL_EMISSION              = int(z'1600', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SHININESS             = int(z'1601', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_AMBIENT_AND_DIFFUSE   = int(z'1602', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_INDEXES         = int(z'1603', kind=GLenum)
!  MatrixMode values
INTEGER(GLenum), PARAMETER :: GL_MODELVIEW             = int(z'1700', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROJECTION            = int(z'1701', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE               = int(z'1702', kind=GLenum)
!  MeshMode1 values
!  MeshMode2 values
!  MinmaxTarget values
!  NormalPointerType values
!  PixelCopyType values
INTEGER(GLenum), PARAMETER :: GL_COLOR                 = int(z'1800', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH                 = int(z'1801', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL               = int(z'1802', kind=GLenum)
!  PixelFormat values
INTEGER(GLenum), PARAMETER :: GL_COLOR_INDEX           = int(z'1900', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_STENCIL_INDEX         = int(z'1901', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DEPTH_COMPONENT       = int(z'1902', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RED                   = int(z'1903', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_GREEN                 = int(z'1904', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLUE                  = int(z'1905', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA                 = int(z'1906', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB                   = int(z'1907', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGBA                  = int(z'1908', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE             = int(z'1909', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE_ALPHA       = int(z'190A', kind=GLenum)
!  PixelInternalFormat values
!  PixelMap values
!  PixelStore values
!  PixelTransfer values
!  PixelType values
INTEGER(GLenum), PARAMETER :: GL_BITMAP                = int(z'1A00', kind=GLenum)
!  PolygonMode values
INTEGER(GLenum), PARAMETER :: GL_POINT                 = int(z'1B00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINE                  = int(z'1B01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FILL                  = int(z'1B02', kind=GLenum)
!  ReadBufferMode values
!  RenderingMode values
INTEGER(GLenum), PARAMETER :: GL_RENDER                = int(z'1C00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FEEDBACK              = int(z'1C01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SELECT                = int(z'1C02', kind=GLenum)
!  SeparableTarget values
!  ShadingModel values
INTEGER(GLenum), PARAMETER :: GL_FLAT                  = int(z'1D00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SMOOTH                = int(z'1D01', kind=GLenum)
!  StencilFunction values
!  StencilOp values
INTEGER(GLenum), PARAMETER :: GL_KEEP                  = int(z'1E00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_REPLACE               = int(z'1E01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INCR                  = int(z'1E02', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DECR                  = int(z'1E03', kind=GLenum)
!  StringName values
INTEGER(GLenum), PARAMETER :: GL_VENDOR                = int(z'1F00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RENDERER              = int(z'1F01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_VERSION               = int(z'1F02', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EXTENSIONS            = int(z'1F03', kind=GLenum)
!  TextureCoordName values
INTEGER(GLenum), PARAMETER :: GL_S                     = int(z'2000', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T                     = int(z'2001', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_R                     = int(z'2002', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_Q                     = int(z'2003', kind=GLenum)
!  TexCoordPointerType values
!  TextureEnvMode values
INTEGER(GLenum), PARAMETER :: GL_MODULATE              = int(z'2100', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_DECAL                 = int(z'2101', kind=GLenum)
!  TextureEnvParameter values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_ENV_MODE      = int(z'2200', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_ENV_COLOR     = int(z'2201', kind=GLenum)
!  TextureEnvTarget values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_ENV           = int(z'2300', kind=GLenum)
!  TextureGenMode values
INTEGER(GLenum), PARAMETER :: GL_EYE_LINEAR            = int(z'2400', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OBJECT_LINEAR         = int(z'2401', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SPHERE_MAP            = int(z'2402', kind=GLenum)
!  TextureGenParameter values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_GEN_MODE      = int(z'2500', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OBJECT_PLANE          = int(z'2501', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EYE_PLANE             = int(z'2502', kind=GLenum)
!  TextureMagFilter values
INTEGER(GLenum), PARAMETER :: GL_NEAREST               = int(z'2600', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINEAR                = int(z'2601', kind=GLenum)
!  TextureMinFilter values
INTEGER(GLenum), PARAMETER :: GL_NEAREST_MIPMAP_NEAREST = int(z'2700', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINEAR_MIPMAP_NEAREST = int(z'2701', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NEAREST_MIPMAP_LINEAR = int(z'2702', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LINEAR_MIPMAP_LINEAR  = int(z'2703', kind=GLenum)
!  TextureParameterName values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_MAG_FILTER    = int(z'2800', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_MIN_FILTER    = int(z'2801', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_WRAP_S        = int(z'2802', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_WRAP_T        = int(z'2803', kind=GLenum)
!  TextureTarget values
!  TextureUnit values
!  TextureWrapMode values
INTEGER(GLenum), PARAMETER :: GL_CLAMP                 = int(z'2900', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_REPEAT                = int(z'2901', kind=GLenum)
!  VertexPointerType values
!  ClientAttribMask values
INTEGER(GLbitfield), PARAMETER :: GL_CLIENT_PIXEL_STORE_BIT = int(z'00000001', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_CLIENT_VERTEX_ARRAY_BIT = int(z'00000002', kind=GLbitfield)
INTEGER(GLbitfield), PARAMETER :: GL_CLIENT_ALL_ATTRIB_BITS = -1 ! i.e. z'ffffffff'
!  polygon_offset values
INTEGER(GLenum), PARAMETER :: GL_POLYGON_OFFSET_FACTOR = int(z'8038', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_OFFSET_UNITS  = int(z'2A00', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_OFFSET_POINT  = int(z'2A01', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_OFFSET_LINE   = int(z'2A02', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POLYGON_OFFSET_FILL   = int(z'8037', kind=GLenum)
!  texture values
INTEGER(GLenum), PARAMETER :: GL_ALPHA4                = int(z'803B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA8                = int(z'803C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA12               = int(z'803D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALPHA16               = int(z'803E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE4            = int(z'803F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE8            = int(z'8040', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE12           = int(z'8041', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE16           = int(z'8042', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE4_ALPHA4     = int(z'8043', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE6_ALPHA2     = int(z'8044', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE8_ALPHA8     = int(z'8045', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE12_ALPHA4    = int(z'8046', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE12_ALPHA12   = int(z'8047', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_LUMINANCE16_ALPHA16   = int(z'8048', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INTENSITY             = int(z'8049', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INTENSITY4            = int(z'804A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INTENSITY8            = int(z'804B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INTENSITY12           = int(z'804C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INTENSITY16           = int(z'804D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_R3_G3_B2              = int(z'2A10', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB4                  = int(z'804F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB5                  = int(z'8050', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB8                  = int(z'8051', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB10                 = int(z'8052', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB12                 = int(z'8053', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB16                 = int(z'8054', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGBA2                 = int(z'8055', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGBA4                 = int(z'8056', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB5_A1               = int(z'8057', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGBA8                 = int(z'8058', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB10_A2              = int(z'8059', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGBA12                = int(z'805A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGBA16                = int(z'805B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_RED_SIZE      = int(z'805C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_GREEN_SIZE    = int(z'805D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_BLUE_SIZE     = int(z'805E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_ALPHA_SIZE    = int(z'805F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_LUMINANCE_SIZE = int(z'8060', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_INTENSITY_SIZE = int(z'8061', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROXY_TEXTURE_1D      = int(z'8063', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROXY_TEXTURE_2D      = int(z'8064', kind=GLenum)
!  texture_object values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_PRIORITY      = int(z'8066', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_RESIDENT      = int(z'8067', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_BINDING_1D    = int(z'8068', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_BINDING_2D    = int(z'8069', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_BINDING_3D    = int(z'806A', kind=GLenum)
!  vertex_array values
INTEGER(GLenum), PARAMETER :: GL_VERTEX_ARRAY          = int(z'8074', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NORMAL_ARRAY          = int(z'8075', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_ARRAY           = int(z'8076', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_ARRAY           = int(z'8077', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_COORD_ARRAY   = int(z'8078', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EDGE_FLAG_ARRAY       = int(z'8079', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_VERTEX_ARRAY_SIZE     = int(z'807A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_VERTEX_ARRAY_TYPE     = int(z'807B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_VERTEX_ARRAY_STRIDE   = int(z'807C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NORMAL_ARRAY_TYPE     = int(z'807E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NORMAL_ARRAY_STRIDE   = int(z'807F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_ARRAY_SIZE      = int(z'8081', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_ARRAY_TYPE      = int(z'8082', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_ARRAY_STRIDE    = int(z'8083', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_ARRAY_TYPE      = int(z'8085', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_ARRAY_STRIDE    = int(z'8086', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_COORD_ARRAY_SIZE = int(z'8088', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_COORD_ARRAY_TYPE = int(z'8089', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_COORD_ARRAY_STRIDE = int(z'808A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EDGE_FLAG_ARRAY_STRIDE = int(z'808C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_VERTEX_ARRAY_POINTER  = int(z'808E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_NORMAL_ARRAY_POINTER  = int(z'808F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_ARRAY_POINTER   = int(z'8090', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INDEX_ARRAY_POINTER   = int(z'8091', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_COORD_ARRAY_POINTER = int(z'8092', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_EDGE_FLAG_ARRAY_POINTER = int(z'8093', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_V2F                   = int(z'2A20', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_V3F                   = int(z'2A21', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_C4UB_V2F              = int(z'2A22', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_C4UB_V3F              = int(z'2A23', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_C3F_V3F               = int(z'2A24', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_N3F_V3F               = int(z'2A25', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_C4F_N3F_V3F           = int(z'2A26', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T2F_V3F               = int(z'2A27', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T4F_V4F               = int(z'2A28', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T2F_C4UB_V3F          = int(z'2A29', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T2F_C3F_V3F           = int(z'2A2A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T2F_N3F_V3F           = int(z'2A2B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T2F_C4F_N3F_V3F       = int(z'2A2C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_T4F_C4F_N3F_V4F       = int(z'2A2D', kind=GLenum)
!  bgra values
INTEGER(GLenum), PARAMETER :: GL_BGR                   = int(z'80E0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BGRA                  = int(z'80E1', kind=GLenum)
!  blend_color values
INTEGER(GLenum), PARAMETER :: GL_CONSTANT_COLOR        = int(z'8001', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_CONSTANT_COLOR = int(z'8002', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONSTANT_ALPHA        = int(z'8003', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_CONSTANT_ALPHA = int(z'8004', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLEND_COLOR           = int(z'8005', kind=GLenum)
!  blend_minmax values
INTEGER(GLenum), PARAMETER :: GL_FUNC_ADD              = int(z'8006', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MIN                   = int(z'8007', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX                   = int(z'8008', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLEND_EQUATION        = int(z'8009', kind=GLenum)
!  blend_subtract values
INTEGER(GLenum), PARAMETER :: GL_FUNC_SUBTRACT         = int(z'800A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FUNC_REVERSE_SUBTRACT = int(z'800B', kind=GLenum)
!  color_matrix values
INTEGER(GLenum), PARAMETER :: GL_COLOR_MATRIX          = int(z'80B1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_MATRIX_STACK_DEPTH = int(z'80B2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_COLOR_MATRIX_STACK_DEPTH = int(z'80B3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_RED_SCALE = int(z'80B4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_GREEN_SCALE = int(z'80B5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_BLUE_SCALE = int(z'80B6', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_ALPHA_SCALE = int(z'80B7', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_RED_BIAS = int(z'80B8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_GREEN_BIAS = int(z'80B9', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_BLUE_BIAS = int(z'80BA', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_ALPHA_BIAS = int(z'80BB', kind=GLenum)
!  color_table values
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE           = int(z'80D0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_COLOR_TABLE = int(z'80D1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_COLOR_MATRIX_COLOR_TABLE = int(z'80D2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROXY_COLOR_TABLE     = int(z'80D3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROXY_POST_CONVOLUTION_COLOR_TABLE = int(z'80D4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROXY_POST_COLOR_MATRIX_COLOR_TABLE = int(z'80D5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_SCALE     = int(z'80D6', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_BIAS      = int(z'80D7', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_FORMAT    = int(z'80D8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_WIDTH     = int(z'80D9', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_RED_SIZE  = int(z'80DA', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_GREEN_SIZE = int(z'80DB', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_BLUE_SIZE = int(z'80DC', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_ALPHA_SIZE = int(z'80DD', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_LUMINANCE_SIZE = int(z'80DE', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COLOR_TABLE_INTENSITY_SIZE = int(z'80DF', kind=GLenum)
!  convolution values
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_1D        = int(z'8010', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_2D        = int(z'8011', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SEPARABLE_2D          = int(z'8012', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_BORDER_MODE = int(z'8013', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_FILTER_SCALE = int(z'8014', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_FILTER_BIAS = int(z'8015', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_REDUCE                = int(z'8016', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_FORMAT    = int(z'8017', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_WIDTH     = int(z'8018', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_HEIGHT    = int(z'8019', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_CONVOLUTION_WIDTH = int(z'801A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_CONVOLUTION_HEIGHT = int(z'801B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_RED_SCALE = int(z'801C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_GREEN_SCALE = int(z'801D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_BLUE_SCALE = int(z'801E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_ALPHA_SCALE = int(z'801F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_RED_BIAS = int(z'8020', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_GREEN_BIAS = int(z'8021', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_BLUE_BIAS = int(z'8022', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_POST_CONVOLUTION_ALPHA_BIAS = int(z'8023', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONSTANT_BORDER       = int(z'8151', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_REPLICATE_BORDER      = int(z'8153', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONVOLUTION_BORDER_COLOR = int(z'8154', kind=GLenum)
!  draw_range_elements values
INTEGER(GLenum), PARAMETER :: GL_MAX_ELEMENTS_VERTICES = int(z'80E8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_ELEMENTS_INDICES  = int(z'80E9', kind=GLenum)
!  histogram values
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM             = int(z'8024', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROXY_HISTOGRAM       = int(z'8025', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_WIDTH       = int(z'8026', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_FORMAT      = int(z'8027', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_RED_SIZE    = int(z'8028', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_GREEN_SIZE  = int(z'8029', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_BLUE_SIZE   = int(z'802A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_ALPHA_SIZE  = int(z'802B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_LUMINANCE_SIZE = int(z'802C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_HISTOGRAM_SINK        = int(z'802D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MINMAX                = int(z'802E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MINMAX_FORMAT         = int(z'802F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MINMAX_SINK           = int(z'8030', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TABLE_TOO_LARGE       = int(z'8031', kind=GLenum)
!  packed_pixels values
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_BYTE_3_3_2   = int(z'8032', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_SHORT_4_4_4_4 = int(z'8033', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_SHORT_5_5_5_1 = int(z'8034', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_INT_8_8_8_8  = int(z'8035', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_INT_10_10_10_2 = int(z'8036', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_BYTE_2_3_3_REV = int(z'8362', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_SHORT_5_6_5  = int(z'8363', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_SHORT_5_6_5_REV = int(z'8364', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_SHORT_4_4_4_4_REV = int(z'8365', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_SHORT_1_5_5_5_REV = int(z'8366', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_INT_8_8_8_8_REV = int(z'8367', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNSIGNED_INT_2_10_10_10_REV = int(z'8368', kind=GLenum)
!  rescale_normal values
INTEGER(GLenum), PARAMETER :: GL_RESCALE_NORMAL        = int(z'803A', kind=GLenum)
!  separate_specular_color values
INTEGER(GLenum), PARAMETER :: GL_LIGHT_MODEL_COLOR_CONTROL = int(z'81F8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SINGLE_COLOR          = int(z'81F9', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SEPARATE_SPECULAR_COLOR = int(z'81FA', kind=GLenum)
!  texture3D values
INTEGER(GLenum), PARAMETER :: GL_PACK_SKIP_IMAGES      = int(z'806B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PACK_IMAGE_HEIGHT     = int(z'806C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_SKIP_IMAGES    = int(z'806D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_UNPACK_IMAGE_HEIGHT   = int(z'806E', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_3D            = int(z'806F', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PROXY_TEXTURE_3D      = int(z'8070', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_DEPTH         = int(z'8071', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_WRAP_R        = int(z'8072', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_3D_TEXTURE_SIZE   = int(z'8073', kind=GLenum)
!  texture_edge_clamp values
INTEGER(GLenum), PARAMETER :: GL_CLAMP_TO_EDGE         = int(z'812F', kind=GLenum)
!  texture_lod values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_MIN_LOD       = int(z'813A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_MAX_LOD       = int(z'813B', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_BASE_LEVEL    = int(z'813C', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE_MAX_LEVEL     = int(z'813D', kind=GLenum)
!  GetTarget1_2 values
INTEGER(GLenum), PARAMETER :: GL_SMOOTH_POINT_SIZE_RANGE = int(z'0B12', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SMOOTH_POINT_SIZE_GRANULARITY = int(z'0B13', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SMOOTH_LINE_WIDTH_RANGE = int(z'0B22', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SMOOTH_LINE_WIDTH_GRANULARITY = int(z'0B23', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALIASED_POINT_SIZE_RANGE = int(z'846D', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ALIASED_LINE_WIDTH_RANGE = int(z'846E', kind=GLenum)
!  multitexture values
INTEGER(GLenum), PARAMETER :: GL_TEXTURE0_ARB          = int(z'84C0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE1_ARB          = int(z'84C1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE2_ARB          = int(z'84C2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE3_ARB          = int(z'84C3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE4_ARB          = int(z'84C4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE5_ARB          = int(z'84C5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE6_ARB          = int(z'84C6', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE7_ARB          = int(z'84C7', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE8_ARB          = int(z'84C8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE9_ARB          = int(z'84C9', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE10_ARB         = int(z'84CA', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE11_ARB         = int(z'84CB', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE12_ARB         = int(z'84CC', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE13_ARB         = int(z'84CD', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE14_ARB         = int(z'84CE', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE15_ARB         = int(z'84CF', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE16_ARB         = int(z'84D0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE17_ARB         = int(z'84D1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE18_ARB         = int(z'84D2', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE19_ARB         = int(z'84D3', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE20_ARB         = int(z'84D4', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE21_ARB         = int(z'84D5', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE22_ARB         = int(z'84D6', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE23_ARB         = int(z'84D7', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE24_ARB         = int(z'84D8', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE25_ARB         = int(z'84D9', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE26_ARB         = int(z'84DA', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE27_ARB         = int(z'84DB', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE28_ARB         = int(z'84DC', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE29_ARB         = int(z'84DD', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE30_ARB         = int(z'84DE', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_TEXTURE31_ARB         = int(z'84DF', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ACTIVE_TEXTURE_ARB    = int(z'84E0', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CLIENT_ACTIVE_TEXTURE_ARB = int(z'84E1', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_TEXTURE_UNITS_ARB = int(z'84E2', kind=GLenum)
!  EXT_abgr values
INTEGER(GLenum), PARAMETER :: GL_ABGR_EXT              = int(z'8000', kind=GLenum)
!  EXT_blend_color values
INTEGER(GLenum), PARAMETER :: GL_CONSTANT_COLOR_EXT    = int(z'8001', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_CONSTANT_COLOR_EXT = int(z'8002', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONSTANT_ALPHA_EXT    = int(z'8003', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ONE_MINUS_CONSTANT_ALPHA_EXT = int(z'8004', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLEND_COLOR_EXT       = int(z'8005', kind=GLenum)
!  EXT_blend_minmax values
INTEGER(GLenum), PARAMETER :: GL_FUNC_ADD_EXT          = int(z'8006', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MIN_EXT               = int(z'8007', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_MAX_EXT               = int(z'8008', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_BLEND_EQUATION_EXT    = int(z'8009', kind=GLenum)
!  EXT_blend_subtract values
INTEGER(GLenum), PARAMETER :: GL_FUNC_SUBTRACT_EXT     = int(z'800A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_FUNC_REVERSE_SUBTRACT_EXT = int(z'800B', kind=GLenum)
!  EXT_texture_env_combine values
INTEGER(GLenum), PARAMETER :: GL_COMBINE_EXT           = int(z'8570', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COMBINE_RGB_EXT       = int(z'8571', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_COMBINE_ALPHA_EXT     = int(z'8572', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_RGB_SCALE_EXT         = int(z'8573', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_ADD_SIGNED_EXT        = int(z'8574', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_INTERPOLATE_EXT       = int(z'8575', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_CONSTANT_EXT          = int(z'8576', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PRIMARY_COLOR_EXT     = int(z'8577', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_PREVIOUS_EXT          = int(z'8578', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SOURCE0_RGB_EXT       = int(z'8580', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SOURCE1_RGB_EXT       = int(z'8581', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SOURCE2_RGB_EXT       = int(z'8582', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SOURCE0_ALPHA_EXT     = int(z'8588', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SOURCE1_ALPHA_EXT     = int(z'8589', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_SOURCE2_ALPHA_EXT     = int(z'858A', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OPERAND0_RGB_EXT      = int(z'8590', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OPERAND1_RGB_EXT      = int(z'8591', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OPERAND2_RGB_EXT      = int(z'8592', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OPERAND0_ALPHA_EXT    = int(z'8598', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OPERAND1_ALPHA_EXT    = int(z'8599', kind=GLenum)
INTEGER(GLenum), PARAMETER :: GL_OPERAND2_ALPHA_EXT    = int(z'859A', kind=GLenum)
