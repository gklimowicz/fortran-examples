...
select case(task)
case(41)
  open(50,file='VCL1D.OUT',form='FORMATTED',action='WRITE')
  open(51,file='VLINES.OUT',form='FORMATTED',action='WRITE')
  call plot1d(50,51,1,vclmt,vclir)
  close(50)
  close(51)
  open(50,file='VXC1D.OUT',form='FORMATTED',action='WRITE')
  open(51,file='VLINES.OUT',form='FORMATTED',action='WRITE')
...
case(42)
  open(50,file='VCL2D.OUT',form='FORMATTED',action='WRITE')
  call plot2d(.false.,50,1,vclmt,vclir)
  close(50)
  open(50,file='VXC2D.OUT',form='FORMATTED',action='WRITE')
...
case(43)
  open(50,file='VCL3D.OUT',form='FORMATTED',action='WRITE')
  call plot3d(50,1,vclmt,vclir)
  close(50)
  open(50,file='VXC3D.OUT',form='FORMATTED',action='WRITE')
