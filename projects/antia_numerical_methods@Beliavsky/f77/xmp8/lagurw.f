...
51    FORMAT(5X,'IER =',I4,'    N =',I4,5X,'ALP =',1PD14.6
     1       /9X,'ABSCISSAS',10X,'WEIGHTS'/(D22.14,5X,D22.14))
52    FORMAT(/'   MAXIMUM RELATIVE ERROR USING ',I4,' POINTS =',1PD12.4)
 

100   PRINT *,'TYPE  NT=NO. OF POINTS IN QUADRATURE FORMULA, ALP'
      PRINT *,'           (QUITS WHEN NT.LE.0)'
      READ *, NT,ALP
      IF(NT.LE.0) STOP

      CALL LAGURW(NT,ALP,W,X,IER,WK)
      WRITE(6,51) IER,NT,ALP,(X(I),W(I),I=1,NT)
