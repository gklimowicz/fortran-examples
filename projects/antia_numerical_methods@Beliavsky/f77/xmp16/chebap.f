!     PROGRAM TO FIND COEFFICIENTS OF RATIONAL FUNCTION APPROXIMATION 
!     IN TERMS OF CHEBYSHEV POLYNOMIALS USING THE KNOWN CHEBYSHEV EXPANSION

      PROGRAM CHEBY
      IMPLICIT REAL*16(A-H,O-Z)
      DIMENSION A(20),WK(100),C(20),IWK(10)

!     EXAMPLE 10.9 : ARC TAN(X)

51    FORMAT('   IER =',I4,5X,'M =',I4,5X,'K =',I3/4X,
...
!     COEFFICIENTS OF CHEBYSHEV EXPANSION OF ARC TAN(X)
      ...
      RM=SQRT(2.Q0)-1.
      DO 1000 I=1,M+2*K+1,2
        C(I)=0.0
        C(I+1)=2.*(-1)**(I/2)*RM**I/I
1000  CONTINUE

      CALL CHEBAP(M,K,A,C,IER,WK,IWK)
