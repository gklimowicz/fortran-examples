!     PROGRAM TO FIND REAL ROOT OF A NONLINEAR EQUATION USING
!     NEWTON-RAPHSON METHOD WITH MODIFICATIONS FOR TREATING MULTIPLE ROOTS
...
!	get a new estimate for multiplicity MR
          MR1=MR
          MR2=MR
          IF(DXR.LT.0.99Q0) MR1=MR/(1.-DXR)+0.5
          IF(DXR1.LT.0.99Q0) MR2=MR/(1.-DXR1)+0.5
