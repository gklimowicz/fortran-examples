...
51    FORMAT('   NO. OF PTS =',2I4,5X,'DEGREE OF POLYNOMIAL =',2I3,5X,
     1       'IER =',I4/5X,'CHI SQUARE=',1PE14.7)
52    FORMAT('   COEFFICIENTS :'/(1P5E14.6))
56    FORMAT('  X =',1P2E14.6,5X,'F =',E14.6/5X,4HF' =,2E14.6/
     1       5X,4HF''=,3E14.6)
57    FORMAT('   TRUE VALUES :',6X,'F =',1PE14.6/5X,4HF' =,2E14.6/5X,
     1        4HF''=,3E14.6)
