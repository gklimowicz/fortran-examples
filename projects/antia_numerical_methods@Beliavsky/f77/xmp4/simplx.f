...
52    FORMAT('  IER =',I4,5X,'MINIMUM =',1PE14.6,5X/
     1       '  OPTIMAL FEASIBLE VECTOR :',3E14.6/(2X,5E14.6))
53    FORMAT('   COST COEFFICIENTS :',1P4E14.6/(2X,5E14.6))
54    FORMAT('    CONSTRAINTS')
55    FORMAT(2X,1PE14.6,2X,4E14.6/(2X,5E14.6))
