...
!     In single precision it is only possible to find crude approximations
!     using this program
...
51    FORMAT('   IER =',I4,5X,'MAX. ERROR =',1PE14.6/
     1       '   COEF. IN NUMERATOR',4E16.8/(2X,5E16.8))
52    FORMAT('   COEF. IN DENOMINATOR',1P4E16.8/(2X,5E16.8))
53    FORMAT('  EXTREMA IN ERROR CURVE',1P4E14.6/(2X,5E14.6))
54    FORMAT('   M =',I3,5X,'K =',I3,5X,'N =',I3,5X,'IFLG =',I3)
55    FORMAT('  INITIAL GUESS FOR COEFFICIENTS :',1P2E14.6/
     1       (2X,1P5E14.6))
56    FORMAT('  INITIAL GUESS FOR EXTREMA OF ERROR CURVE :',1P2E14.6/
     1       (2X,1P5E14.6))
...
2300    FD=FD*X+A(K-J)
      ...
      FM=(FM-FUND(X)*FN/FD)*SIGN(1.0,SI)
      END
...
!	It is not possible to find approximations with maximum error
!	close to machine accuracy and hence the routine may not work
!	properly in single precision.
!
