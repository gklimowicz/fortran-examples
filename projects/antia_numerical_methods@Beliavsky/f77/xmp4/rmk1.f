...
51    FORMAT('   M =',I4,4X,'K =',I3,5X,'X =',1PE14.6,
     1       3X,'RMK(X) =',E14.6)
52    FORMAT('   RMK(X) =',1PE14.6,5X,9HRMK'(X) =,E14.6)
53    FORMAT('   COEFFICIENTS IN NUMERATOR :',1P3E14.6/(5E14.6))
54    FORMAT('   COEFFICIENTS IN DENOMINATOR :',1P3E14.6/(5E14.6))
