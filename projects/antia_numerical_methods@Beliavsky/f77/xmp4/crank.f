...
51    FORMAT('   IER =',I4,5X,'T =',1PE14.6,5X,'TIME STEP =',E14.6,5X,
     1       'NX =',I4/5X,'SOLUTION =',4E14.6/(2X,5E14.6))
52    FORMAT('   EXACT SOLUTION =',1P4E14.6/(2X,5E14.6))
...
!     Since time is computed by repeated addition of DT, there can beC     significant roundoff error in time itself and as a result even
!     the exact solution may not be evaluated at the required time
!     giving significant errors. Compare the output from single and
!     double precision versions to see the difference.
