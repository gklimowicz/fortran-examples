!     PROGRAM FOR MINIMISATION IN ONE DIMENSION USING BRENT'S METHOD
...
51    FORMAT('  INITIAL BRACKETING TRIPLET :',1P3E14.6)
52    FORMAT('    FINAL BRACKETING TRIPLET :',1P3E14.6/
     1     5X,'IER =',I4,5X,'MINIMISER =',E14.6,5X,'MINIMUM =',E14.6)
