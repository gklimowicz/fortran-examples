!     PROGRAM FOR MINIMISING A FUNCTION OF N VARIABLES USING
...
!     EXAMPLE 8.5: ROSENBROCK'S FUNCTION

51    FORMAT('   STARTING VALUES :',1P4E14.6/(2X,5E14.6))
52    FORMAT('   IER =',I4,5X,'MINIMISER =',1P4E14.6/(2X,5E14.6))
