...
52    FORMAT(10F8.3)
53    FORMAT('   IER =',I4,5X,'DIAGONAL ELEMENTS =',1P3E14.6/
     1       (2X,5E14.6))
54    FORMAT('   OFF DIAGONAL ELEMENTS =',1P3E14.6/(2X,5E14.6))
55    FORMAT('   TRANSFORMATION MATRIX FOR REDUCTION TO TRIDIAGONAL'
     1       ,' FORM')
56    FORMAT(1P6E13.5)
57    FORMAT('    IER =',I4/'   EIGENVALUE',9X,'EIGENVECTOR')
58    FORMAT(1PE14.6,2X,4E14.6/(5X,5E14.6))
59    FORMAT('   IER =',I4,5X,'M1 =',I3,5X,'M2 =',I3/
     1       '  EIGENVALUES =',1P4E14.6/(2X,5E14.6))
