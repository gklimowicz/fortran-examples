...
51    FORMAT('   IER =',I4,5X,'T =',1PE14.6,5X,
     1   'NO. OF FUNCTION EVALUATIONS =',I8/5X,'STEP SIZE =',E14.6,5X
     2   ,'SOLUTION =',2E14.6/(2X,5E14.6))
52    FORMAT('   T0 =',1PE14.6,5X,'INITIAL STEP SIZE =',E14.6,5X,
     1   'IFLG =',I2,5X,'IST =',I2)
