...
PRIVATE
!  Boolean values
INTEGER(GLboolean), PARAMETER, PUBLIC :: GLU_FALSE                = 0
INTEGER(GLboolean), PARAMETER, PUBLIC :: GLU_TRUE                 = 1
!  Version values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_VERSION_1_1          = 1
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_VERSION_1_2          = 1
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_VERSION_1_3          = 1
!  StringName values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_VERSION              = 100800
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_EXTENSIONS           = 100801
!  ErrorCode values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_INVALID_ENUM         = 100900
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_INVALID_VALUE        = 100901
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OUT_OF_MEMORY        = 100902
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_INVALID_OPERATION    = 100904
!  NurbsDisplay values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OUTLINE_POLYGON      = 100240
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OUTLINE_PATCH        = 100241
!  NurbsCallback values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR          = 100103
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_ERROR                = 100103
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_BEGIN          = 100164
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_BEGIN_EXT      = 100164
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_VERTEX         = 100165
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_VERTEX_EXT     = 100165
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_NORMAL         = 100166
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_NORMAL_EXT     = 100166
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_COLOR          = 100167
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_COLOR_EXT      = 100167
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_TEXTURE_COORD  = 100168
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_TEX_COORD_EXT  = 100168
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_END            = 100169
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_END_EXT        = 100169
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_BEGIN_DATA     = 100170
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_BEGIN_DATA_EXT = 100170
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_VERTEX_DATA    = 100171
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_VERTEX_DATA_EXT = 100171
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_NORMAL_DATA    = 100172
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_NORMAL_DATA_EXT = 100172
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_COLOR_DATA     = 100173
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_COLOR_DATA_EXT = 100173
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_TEXTURE_COORD_DATA = 100174
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_TEX_COORD_DATA_EXT = 100174
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_END_DATA       = 100175
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_END_DATA_EXT   = 100175
!  NurbsError values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR1         = 100251
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR2         = 100252
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR3         = 100253
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR4         = 100254
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR5         = 100255
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR6         = 100256
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR7         = 100257
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR8         = 100258
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR9         = 100259
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR10        = 100260
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR11        = 100261
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR12        = 100262
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR13        = 100263
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR14        = 100264
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR15        = 100265
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR16        = 100266
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR17        = 100267
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR18        = 100268
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR19        = 100269
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR20        = 100270
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR21        = 100271
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR22        = 100272
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR23        = 100273
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR24        = 100274
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR25        = 100275
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR26        = 100276
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR27        = 100277
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR28        = 100278
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR29        = 100279
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR30        = 100280
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR31        = 100281
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR32        = 100282
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR33        = 100283
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR34        = 100284
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR35        = 100285
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR36        = 100286
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_ERROR37        = 100287
!  NurbsProperty values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_AUTO_LOAD_MATRIX     = 100200
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_CULLING              = 100201
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_SAMPLING_TOLERANCE   = 100203
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_DISPLAY_MODE         = 100204
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_PARAMETRIC_TOLERANCE = 100202
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_SAMPLING_METHOD      = 100205
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_U_STEP               = 100206
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_V_STEP               = 100207
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_MODE           = 100160
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_MODE_EXT       = 100160
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_TESSELLATOR    = 100161
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_TESSELLATOR_EXT = 100161
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_RENDERER       = 100162
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NURBS_RENDERER_EXT   = 100162
!  NurbsSampling values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OBJECT_PARAMETRIC_ERROR = 100208
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OBJECT_PARAMETRIC_ERROR_EXT = 100208
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OBJECT_PATH_LENGTH   = 100209
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OBJECT_PATH_LENGTH_EXT = 100209
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_PATH_LENGTH          = 100215
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_PARAMETRIC_ERROR     = 100216
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_DOMAIN_DISTANCE      = 100217
!  NurbsTrim values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_MAP1_TRIM_2          = 100210
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_MAP1_TRIM_3          = 100211
!  QuadricDrawStyle values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_POINT                = 100010
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_LINE                 = 100011
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_FILL                 = 100012
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_SILHOUETTE           = 100013
!  QuadricCallback values
!  QuadricNormal values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_SMOOTH               = 100000
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_FLAT                 = 100001
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_NONE                 = 100002
!  QuadricOrientation values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_OUTSIDE              = 100020
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_INSIDE               = 100021
!  TessCallback values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_BEGIN           = 100100
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_BEGIN                = 100100
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_VERTEX          = 100101
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_VERTEX               = 100101
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_END             = 100102
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_END                  = 100102
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR           = 100103
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_EDGE_FLAG       = 100104
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_EDGE_FLAG            = 100104
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_COMBINE         = 100105
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_BEGIN_DATA      = 100106
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_VERTEX_DATA     = 100107
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_END_DATA        = 100108
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR_DATA      = 100109
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_EDGE_FLAG_DATA  = 100110
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_COMBINE_DATA    = 100111
!  TessContour values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_CW                   = 100120
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_CCW                  = 100121
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_INTERIOR             = 100122
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_EXTERIOR             = 100123
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_UNKNOWN              = 100124
!  TessProperty values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_WINDING_RULE    = 100140
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_BOUNDARY_ONLY   = 100141
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_TOLERANCE       = 100142
!  TessError values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR1          = 100151
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR2          = 100152
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR3          = 100153
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR4          = 100154
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR5          = 100155
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR6          = 100156
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR7          = 100157
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_ERROR8          = 100158
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_MISSING_BEGIN_POLYGON = 100151
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_MISSING_BEGIN_CONTOUR = 100152
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_MISSING_END_POLYGON = 100153
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_MISSING_END_CONTOUR = 100154
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_COORD_TOO_LARGE = 100155
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_NEED_COMBINE_CALLBACK = 100156
!  TessWinding values
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_WINDING_ODD     = 100130
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_WINDING_NONZERO = 100131
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_WINDING_POSITIVE = 100132
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_WINDING_NEGATIVE = 100133
INTEGER(GLenum), PARAMETER, PUBLIC :: GLU_TESS_WINDING_ABS_GEQ_TWO = 100134
