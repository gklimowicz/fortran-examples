SCM_BOMEX.R GISS Model E      A. Ackerman 11/2014

Single-column mode for Model E: BOMEX intercomparison simulation
...
SCM_PS=SCM_BOMEX.nc      ! surface pressure
SCM_SFLUX=SCM_BOMEX.nc   ! surface heat flux(es)
SCM_TSKIN=SCM_BOMEX.nc   ! skin temperature
SCM_WIND=SCM_BOMEX.nc    ! horizontal wind profile(s)
SCM_GEO=SCM_BOMEX.nc     ! geostrophic wind profile(s)
...
Label and Namelist:
SCM_BOMEX (BOMEX case using Single Column Model)

&&PARAMETERS

! SCM parameters
SCM_lon=-56.               ! BOMEX longitude (deg)
SCM_lat=15.                ! BOMEX latitude (deg)
...
&&END_PARAMETERS
 ...
 YEARI=1969,MONTHI=6,DATEI=22,HOURI=0,
 YEARE=1969,MONTHE=6,DATEE=23,HOURE=0,
/
