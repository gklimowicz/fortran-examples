E6TomaF102clim.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm OMA tracers

This is NOT TUNED in any way. Not ready for Science. Used for now in model development.
E6TomaF102clim = E6TomaF40clim but add changes from LLF40.R-->LLF102.R
  Where the 102L here is: 
  102 smoothed vertical layers with standard hybrid coordinate, top at .002 mb
...
E6TomaF102clim (climatological prescribed ocean atmospheric tracer model with OMA and Shindell chemistry)
...
#include "chemistry_params_102_CMIP6"
