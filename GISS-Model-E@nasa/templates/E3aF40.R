E3aF40.R GISS Model E  1979 ocn/atm                   rar 10/06

E3aF40: replace this section by a description of what distinguishes this run ?
...
ocean data: prescribed, annually varying
...
U00ice=.57      ! same as balanced preliminary run w/clim.ocn
U00wtrX=1.46    ! same as balanced preliminary run w/clim.ocn
...
&&END_PARAMETERS
 ...
 &INPUTZ
   IYEAR1=1950, YEARI=1979,MONTHI=1,DATEI=1,HOURI=0,
                YEARE=2001,MONTHE=1,DATEE=1,HOURE=0, KDIAG=12*0,9,
   ISTART=8,    YEARE=1979,MONTHE=1,DATEE=1,HOURE=1, IRANDI=0,
/
