E6TomaF40.R GISS ModelE Lat-Lon Atmosphere Model, transient ocn/atm OMA tracers
...
E6TomaF40 (prescribed ocean atmospheric tracer model with OMA and Shindell chemistry)
