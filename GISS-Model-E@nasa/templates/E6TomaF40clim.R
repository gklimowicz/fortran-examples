E6TomaF40clim.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm OMA tracers
...
E6TomaF40clim (climatological prescribed ocean atmospheric tracer model with OMA and Shindell chemistry)
