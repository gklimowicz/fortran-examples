E5TgasM20dv.R GISS Model E  2002 modelE                 rar 12/01/03

E5TgasM20dv: E025TgasM20 with Ent 
...
Label and Namelist:
E5TgasM20dv (ModelE1 1980 atm/ocn, 20 layers, Water isotopes)
...
supsatfac=0.004
to_volume_MixRat=1,0,0   ! for tracer printout
to_per_mil=0,1,1   ! for tracer printout

variable_lk=0  ! 1   ! variable lakes

&&END_PARAMETERS
 
 &INPUTZ
   YEARI=2000,MONTHI=1,DATEI=1,HOURI=0, !  from default: IYEAR1=YEARI
   YEARE=2000,MONTHE=1,DATEE=2,HOURE=1, KDIAG=0,2,2,10*0,qcheck=.true.,
   ISTART=2,IRANDI=0,
