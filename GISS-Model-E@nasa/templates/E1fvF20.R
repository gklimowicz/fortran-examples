E1fvF20.R GISS Model E  1979 ocn/atm                   rar 03/04

E1fvF20: replace this section by a description of what distinguishes this run ?
...
modelE1 (3.0) 2x2.5 hor. grid with 20 lyrs, top at .1 mb (+ 3 rad.lyrs)     ?
atmospheric composition from year 1979
ocean data: prescribed, 1975-1984 climatology
uses finite-volume dynamical core
...
Label and Namelist:
E1fvF20 (ModelE1 2x2.5, 20 lyrs, 1979 atm/ocn; use up to 72 (or 80) columns and ??
...
U00ice=.57      ! tune this first to get: glob. ann. mean plan.alb=30% then
U00wtrX=1.44    !       tune this to get: glob. ann. mean net heat at surf. = 0
...
Ndisk=48       ! use =48 if not on halem
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   ISTART=2,IRANDI=0, YEARE=1949,MONTHE=12,DATEE=31,HOURE=0,
/
