E1fvM20.R GISS Model E  2004 modelE             your_name  1/13/07

E1fvM20: description/motivation    (any number of lines) ?
...
FV_UTILS FV_LatLon_Mod FV_INTERFACE ! FV dynamical core wrapper
...
Label and Namelist:
E1fvM20 (ModelE1 4x5, 20 lyrs, 1880 atm/ocn; use up to 72 (or 80) columns and ??
