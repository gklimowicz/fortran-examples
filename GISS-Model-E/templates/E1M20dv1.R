E1M20dv1.R GISS Model E  2004 modelE                 rar 12/01/03

E1M20dv1: rundeck for running GCM coupled to Dynamic Vegatation (Ent).
       It is similar to E1M20 but replaces static vegetation with
       ENT* object files. Subdirectory Ent should be present in the
       modelE/model (at the moment has to be checked out separately)
...
Label and Namelist:
E1M20dv1 (ModelE1 4x5, 20 lyrs, 1880 atm/ocn; use up to 72 (or 80) columns and ??
