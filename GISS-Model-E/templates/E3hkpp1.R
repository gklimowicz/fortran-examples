E3hkpp1.R GISS Model E  coupled version      rar   11/10/2004

E3hkpp1: E3AoM20A + hycom kpp
...
Label and Namelist:
E3hkpp1 (E3 + HYCOM/KPP, nonloc=.false.)
...
U00wtrX=1.41    ! U00wtrX+.01=>nethtz0+.7                for global annual mean
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   ISTART=8,IRANDI=0,YEARE=1800,MONTHE=1,DATEE=2,HOURE=0,IWRITE=1,JWRITE=1,
/

Runs with kpp should always start from rsf file using istart=8
