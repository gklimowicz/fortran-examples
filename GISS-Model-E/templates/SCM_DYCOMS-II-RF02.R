SCM_RF02.R GISS Model E      A. Ackerman 11/2014

Single-column mode for Model E: DYCOMS-II RF02 intercomparison simulation
...
SCM_PS=SCM_DYCOMS-II-RF02.nc      ! surface pressure
SCM_SFLUX=SCM_DYCOMS-II-RF02.nc   ! surface heat flux(es)
...
! SCM parameters
SCM_lon=-121.7             ! DYCOMS-II RF02 longitude (deg)
SCM_lat=31.4               ! DYCOMS-II RF02 latitude (deg)
...
&&END_PARAMETERS
 ...
 YEARI=2001,MONTHI=7,DATEI=11,HOURI=6,
 YEARE=2001,MONTHE=7,DATEE=12,HOURE=6,
/
