...
! prescr. climatological ocean (1 yr data)
...
RADN2=LWTables33k_lowH2O_CO2_O3_planck_1-800                   !     8/2003 version
...
!!! obio_reflectance files
cfle1=abw25b.dat

Label and Namelist:
test (2x2.5x40 latest version; chlorophyll)
...
U00a=.62    ! above 850mb w/o MC region; tune this first to get 30-35% high clouds
U00b=.90    ! below 850mb and MC regions; then tune this to get rad.balance
! U00a,U00b replace the U00 parameters below - U00ice/U00wtrX are kept only for the _E1 version
U00ice=.50       ! tune this first to get: glob. ann. mean plan.alb=30%   (U00ice up=>albedo down)
U00wtrX=1.40     ! this to get: glob. ann. mean net heat at surf. = 0   (U00wtrX+.01=>NetHtSrf+.7)
