E_AR5_CADI_oR.R GISS Model E  1850 ocn/atm/tracers  Larissa   10/13/2010

E_AR5_CADI_oR: E_AR5_CADI coupled to 1x1.25deg 32-layer GISS ocean model
...
E_AR5_CADI_oR (E_AR5_CAD_oR + computed aerosol 1st indirect effect)
