E1CFCnoM20.R     GISS Model E  coupled version          larissa   01/22/2009

E3ntTrOcn: replace this section by a description of what distinguishes this run ?
...
/
!  ISTART=5,IRANDI=0, YEARE=1901,MONTHE=1,DATEE=1,HOURE=1,IWRITE=1,JWRITE=1, !no tracers,CFC
