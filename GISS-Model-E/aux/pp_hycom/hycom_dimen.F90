      module hycom_dimen
      implicit none
#ifdef HYCOM_RES_387x360x26
      integer, public, parameter :: idm=387,jdm=360,kdm=26
#endif
#ifdef HYCOM_RES_387x360x32
      integer, public, parameter :: idm=387,jdm=360,kdm=32
#endif
#ifdef HYCOM_RES_359x360x32
      integer, public, parameter :: idm=359,jdm=360,kdm=32
#endif
#ifdef HYCOM_RES_359x360x26
      integer, public, parameter :: idm=359,jdm=360,kdm=26
#endif
      integer, public, parameter ::  ms=20,ntrcr = 1, equat=229, &
         iia=360,jja=181,k33=33,  &
         ifull=idm, jfull=jdm
      integer, public, parameter :: I_0H=1, I_1H=idm, J_0H=1, J_1H=jdm
      integer :: i,j,k,l,n,jchunk
!
! --- information in common block gindex keeps do loops from running into land
