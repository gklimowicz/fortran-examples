...
C************************************************************************************
C****Add Autoconversion scheme from Seifert and Beheng (2001, Atmos. Res.)*****
          case ('beheng')
            case_action5: select case (trim(action))
              case ("drop_nucl")
                ldummy=beheng_drop_activation(dt0,k0)
              case ("drop_auto")
                ldummy=beheng_drop_autoconversion(dt0,k0)
              case ("drop_rain")
                ldummy= beheng_drop_by_rain_accretion(dt0,k0)
              case default
                msg=trim(tag)//
     *             " Case "//trim(action)//" is not implemented"
                call stop_model(msg,255)
...
C==============================================================================
C
      LOGICAL FUNCTION beheng_drop_autoconversion(dt0,k0) RESULT (la)
c
      IMPLICIT NONE
c
        real*8,             INTENT (in)       :: dt0
...
c
        integer      :: mx0,k=1
c
        logical      :: lprt1,lprt2,lprt3
c
        CHARACTER*28 :: sname='beheng_drop_autoconversion: '
c
        lprt1 = .true.; lprt1 = .false.
        lprt2 = .true.; lprt2 = .false.
        lprt3 = .true.; lprt3 = .false.
c
        la     = .true.
c
        dtmic=dt0!; dtmic=1.0d0
...
cigs
        if(lprt1) then
          print *,sname,'bf: tk3d   = ',tk3d
          print *,sname,'bf: qv3d   = ',qv3d
          print *,sname,'bf: pp3d   = ',pp3d
          print *,sname,'bf: qi3d   = ',qi3d
          print *,sname,'bf: ni3d   = ',ni3d
          print *,sname,'bf: dt     = ',dt
          print *,sname,'bf: dtmic  = ',dtmic
          print *,sname,'bf: ci     = ',ci
          print *,sname,'bf: di     = ',di
          print *,sname,'bf: pi     = ',pi
          print *,sname,'bf: rhow   = ',rhow
          print *,sname,'bf: cs     = ',cs
          print *,sname,'bf: ds     = ',ds
          print *,sname,'bf: dr     = ',dr
          print *,sname,'bf: qsmall = ',qsmall
        endif
c
c Make hydrometeors distributions
c
...
Cigs
        ...
        if(lprt2) then
          print *,sname,'af: lamc   = ',lamc
          print *,sname,'af: lamr   = ',lamr
          print *,sname,'af: lami   = ',lami
          print *,sname,'af: lams   = ',lams
c
          print *,sname,'af: n0i    = ',n0i
          print *,sname,'af: n0s    = ',n0s
          print *,sname,'af: n0rr   = ',n0rr
          print *,sname,'af: pgam   = ',pgam
          print *,sname,'af: cdist1 = ',cdist1
c
          print *,sname,'af: qc3d   = ',qc3d
          print *,sname,'af: qi3d   = ',qi3d
          print *,sname,'af: qs3d   = ',qs3d
          print *,sname,'af: qr3d   = ',qr3d
c
          print *,sname,'af: nc3d   = ',nc3d
          print *,sname,'af: ni3d   = ',ni3d
          print *,sname,'af: ns3d   = ',ns3d
          print *,sname,'af: nr3d   = ',nr3d
c
          print *,sname,'af: effc   = ',effc
          print *,sname,'af: effi   = ',effi
          print *,sname,'af: effs   = ',effs
          print *,sname,'af: effr   = ',effr
c
          print *,sname,'af: dtmic  = ',dtmic
          print *,sname,'af: tk3d   = ',tk3d
          print *,sname,'af: pp3d   = ',pp3d
          print *,sname,'af: nc3d   = ',nc3d
        endif
c
        ldummy=beheng_make_drop_autoconversion(dtmic,mx0)
Cigs
        ...
        if(lprt3) then
          ...
          print *,sname,'af: nr3d   = ',nr3d
          print *,sname,'af: qr3d   = ',qr3d
          print *,sname,'af: nprc   = ',nprc
          print *,sname,'af: ncagg  = ',ncagg
          print *,sname,'af: mprc   = ',mprc
          print *,sname,'af: mcagg  = ',mcagg
        endif
c
        la=.NOT.lcheck
c
      END FUNCTION beheng_drop_autoconversion
C
C==============================================================================
C
      LOGICAL FUNCTION beheng_drop_activation(dt0,k0) RESULT (la)
c
      IMPLICIT NONE
c
        real*8,             INTENT (in)       :: dt0
...
c
        integer      :: mx0,k=1
c
        logical      :: lprt1,lprt2!,make_distribution
c
        character*24 :: sname='beheng_drop_activation: '
c
        lprt1 = .true.; lprt1 = .false.
        lprt2 = .true.; lprt2 = .false.
c
...
c
        ldummy=beheng_make_drop_activation(dtmic,mx0)
c
        la=.NOT.lcheck
c
      END FUNCTION beheng_drop_activation
C
C==============================================================================
C
      LOGICAL FUNCTION beheng_drop_by_rain_accretion(dt0,k0) RESULT (la)
c
      IMPLICIT NONE
c
        real*8,             INTENT (in)       :: dt0
...
c
        logical      :: lprt1,lprt2,lprt3
c
        CHARACTER*32 :: sname='beheng_drop_by_rain_accretion: '
c
        lprt1 = .true.; lprt1 = .false.
        lprt2 = .true.; lprt2 = .false.
        lprt3 = .true.!; lprt3 = .false.
...
c
        ldummy=beheng_make_drop_by_rain_accretion(dtmic,mx0)
c
        if(lprt3) then
          print *,sname,'af: dtmic  = ',dtmic
          print *,sname,'af: nc3d   = ',nc3d
          ...
          print *,sname,'af: nr3d   = ',nr3d
          print *,sname,'af: qr3d   = ',qr3d
          print *,sname,'af: npra   = ',npra
          print *,sname,'af: nragg  = ',nragg
          print *,sname,'af: mpra   = ',mpra
          print *,sname,'af: mragg  = ',mragg
        endif
c
        la=.NOT.lcheck
c
      END FUNCTION beheng_drop_by_rain_accretion
C
C==============================================================================
C
      LOGICAL FUNCTION beheng_make_drop_autoconversion(dtmic,mx0)
     *  RESULT (la)
c
      IMPLICIT NONE
c
...
c Local
c
        real*8, parameter :: rowB=1.0d+03      ! [kg/m^3]
        real*8, parameter :: rB=40.0d-06       ! [m]
        real*8, parameter :: xB=4.0d0*3.141593*rowB*rB*rB*rB/3.0d0 ! [kg]
        real*8, parameter :: kcB=9.44d09       ! [m^3/kg/kg/s]
        real*8, parameter :: krB=5.78d00       ! [m^3/kg/s]
        real*8, parameter :: gB=1.0d0 
        real*8, parameter :: cgB=(gB+2.d0)*(gB+4.d0)/(gB+1.d0)**2/2.0d01
        real*8, parameter :: cmB=cgB*kcB/xB    ! [m^3/kg/kg/kg/s]
        real*8, parameter :: cnB=    2.0/xB    ! [m^3/kg/kg/kg/kg/s]
c counting variables
      integer :: k
c
      real*8  :: tau,Ftau,ctau,rtau,dtau,mtau
      real*8  :: nc3dn,qc3dn,xc3d,xc3dn,rc3d,rc3dn
c
      logical :: lprt,lprt1,lprt2,lprt3,ldrop_auto,ldrop_self
c
        CHARACTER*33 :: sname='beheng_make_drop_autoconversion: '
c
        la     = .true.
c
        lprt = .true.; lprt = .false.
        lprt1= .true.; lprt1= .false. 
        lprt2= .true.; lprt2= .false. 
        lprt3= .true.; lprt3= .false. 
        ldrop_auto = .true.!; ldrop_auto = .false.
...
c
c autoconversion of cloud liquid water to rain
c formula from Seifert & Beheng (2001)
c using numerical simulation of stochastic collection equation
c and initial cloud droplet size distribution specified
c as a gamma distribution THAT depends on MASSES but not on RADII !!!
c

C**************This is used to test the old way of using Beheng's 1994 scheme vs. new one
           if_drop_auto: if (ldrop_auto) then
              go to 1
              nprc(k) = 7.7d9
     1                *(6.0d28/rho(k)*pgam(k)**(-1.7)*
...
c
              xc3d  = (qc3d(k)/nc3d(k))
              rc3d  = 1.d+06*(3*xc3d/(4.*3.14*rowB))**(1./3.)
              nc3dn = nc3d(k)-dtmic*nprc(k)
              qc3dn = qc3d(k)-dtmic*mprc(k)
              xc3dn = (qc3dn/nc3dn)
              rc3dn = 1.d+06*(3*xc3dn/(4.*3.14*rowB))**(1./3.)
c
          print *,sname,'*********** k      = ',k,' ************'
c
          print *,sname,'hm: rc3d   = ',rc3d
          print *,sname,'hm: xc3d   = ',xc3d
          print *,sname,'hm: nc3d   = ',nc3d(k)
          print *,sname,'hm: qc3d   = ',qc3d(k)
          print *,sname,'hm: nprc   = ',nprc(k)
          print *,sname,'hm: mprc   = ',mprc(k)
          print *,sname,'hm: rc3d   = ',rc3dn
          print *,sname,'hm: xc3d   = ',xc3dn
          print *,sname,'hm: nc3dn  = ',nc3dn
          print *,sname,'hm: qc3dn  = ',qc3dn
c
 1            continue
c
C******Here is the new code from Siefert and Beheng 2001 (Atmos. Res. )
              tau = 1.0d0 - qc3d(k) / ( qc3d(k) + qr3d(k))
c             tau = 0.0d0
              ctau= tau**0.68; rtau = 1.0d0 - ctau; dtau = 1.0d0 - tau
c
              Ftau = 6.0d+02 * ctau * rtau * rtau * rtau
              mtau = 1.0d0 + Ftau / (dtau * dtau)

              mprc(k) =                               ! [kg/kg/s]
     1           cmB * (1.0d+0 / rho(k)) *            ! [m^6/kg^4/s]
     1           mtau *
     1           (1.0d-6*rho(k)*nc3d(k))**(-2.0)*     ! conc in [No/cc]
     1           (1.0d-3*rho(k)*qc3d(k))**( 4.0)      ! cont in [g/cc]
...
c
        if(lprt3) then
          print *,sname,'af: tau    = ',tau
          print *,sname,'af: ctau   = ',ctau
          print *,sname,'af: rtau   = ',rtau
          print *,sname,'af: dtau   = ',dtau
          print *,sname,'af: Ftau   = ',Ftau
          print *,sname,'af: mtau   = ',mtau
c
          print *,sname,'hm: xc3d   = ',xc3d
          print *,sname,'hm: rc3d   = ',rc3d
          print *,sname,'hm: nc3d   = ',nc3d(k)
          print *,sname,'hm: qc3d   = ',qc3d(k)
          print *,sname,'af: nprc   = ',nprc(k)
          print *,sname,'af: mprc   = ',mprc(k)
          print *,sname,'af: xc3dn  = ',xc3dn
          print *,sname,'af: rc3dn  = ',rc3dn
          print *,sname,'af: nc3dn  = ',nc3dn
          print *,sname,'af: qc3dn  = ',qc3dn
        endif
c
           else
             if(lprt) 
     1         print *,'Skip autoconversion: k = ',k
...
c
     ...
     1             (1.0d-3*rho(k)*qc3d(k))**2
            ...
            if(lprt) 
     1         print *,'Skip drop self-collection: k = ',k 
           end if if_drop_self
c
          endif if_drop_exists
c
...
c
        la=.NOT.lcheck
c
      END FUNCTION beheng_make_drop_autoconversion
C
C
C==============================================================================
C
      LOGICAL FUNCTION beheng_make_drop_by_rain_accretion(dtmic,mx0)
     *  RESULT (la)
c
      IMPLICIT NONE
c
...
c counting variables
      integer :: k
c
      logical :: lprt,ldrop_rain,lrain_self
c
        CHARACTER*36 :: sname='beheng_make_drop_by_rain_accretion: '
c
        la     = .true.
c
        lprt       = .true.!; lprt = .false.
...
c
            ...
            if(lprt)
     1         print *,'Skip Self-collection rain drops: k = ',k
            endif if_rain_self
c
          endif if_rain_exists
c
...
c
        la=.NOT.lcheck
c
      END FUNCTION beheng_make_drop_by_rain_accretion
C 
C 
C==============================================================================
C 
      LOGICAL FUNCTION beheng_make_drop_activation(dt0,mx0) RESULT (la)
C
      IMPLICIT NONE
C
        real*8,             INTENT (in)       :: dt0
...
C
        integer :: k=1
C
        LOGICAL :: lnucl,lprt1,lprt2,lprt3,lprt4,make_distribution
c
        character*29 :: sname='beheng_make_drop_activation: '
C
        lprt1 = .true.; lprt1 = .false.
        lprt2 = .true.; lprt2 = .false.
        lprt3 = .true.; lprt3 = .false.
        lprt4 = .true.; lprt4 = .false.
C
        la     = .true.
c
        dtmic=dt0!; dtmic=1.0d0
...
c
        if(lprt1) then
          ...
          print *,sname,'bf: qv3d   = ',qv3d
          print *,sname,'bf: pp3d   = ',pp3d
          print *,sname,'bf: ww3d   = ',ww3d
          print *,sname,'bf: wvar   = ',wvar
          print *,sname,'bf: nc3d   = ',nc3d
          print *,sname,'bf: qc3d   = ',qc3d
        endif
c
...
c           print *,k,dum1,dum2,derf1(uu1),derf1(uu2)
...
Cigs
c
        if(lprt3 .AND. lnucl) then
          print *,sname,'k     = ',k
          print *,sname,'rh    = ',dumqv/dumqss
          print *,sname,'tk3d  = ',tk3d(k)
          print *,sname,'qv3d  = ',qv3d(k)
          print *,sname,'pp3d  = ',pp3d(k)
          print *,sname,'dume  = ',dume
          print *,sname,'dum   = ',dum
          print *,sname,'dumt  = ',dumt
          print *,sname,'dumqv = ',dumqv
          print *,sname,'dum1  = ',dum1
          print *,sname,'dum2  = ',dum2
          print *,sname,'dum3  = ',dum3
          print *,sname,'dum4  = ',dum4
          print *,sname,'nc3d  = ',nc3d(k)
          print *,sname,'npccn = ',npccn(k)
          print *,sname,'qc3d  = ',qc3d(k)
          print *,sname,'mpccn = ',mpccn(k)
          print *,sname,'sw    = '
     *      ,1.0d2*(dume/polysvp(dumt,0)-1.0d0)
          print *,sname,'si    = '
     *      ,1.0d2*(dume/polysvp(dumt,1)-1.0d0)
          print *,sname,'xxlv  = ',xxlv(k)
          print *,sname,'xxls  = ',xxls(k)
          print *,sname,'xlf   = ',xlf(k)
          print *,sname,'rho   = ',rho(k)
        endif
           else
            if(lprt4) then
               print *,'Skip droplet activation: k    = ',k
               print *,'Skip droplet activation: rh   = ',dumqv/dumqss
               print *,'Skip droplet activation: tk3d = ',tk3d(k)
               print *,'Skip droplet activation: qv3d = ',qv3d(k)
               print *,'Skip droplet activation: pp3d = ',pp3d(k)
            endif
...
c
        if(lprt2) then
          print *,sname,'k     = ',k
          print *,sname,'dtmic = ',dtmic
          print *,sname,'tk3d  = ',tk3d
          print *,sname,'qv3d  = ',qv3d
          print *,sname,'pp3d  = ',pp3d
c          print *,sname,'sw    = ',hugh_make_supw(pp3d,tk3d,qv3d)
c          print *,sname,'si    = ',hugh_make_supi(pp3d,tk3d,qv3d)
          print *,sname,'xxlv = ',xxlv
          print *,sname,'xxls = ',xxls
          print *,sname,'xlf  = ',xlf
          print *,sname,'rho  = ',rho
          print *,sname,'nc3d  = ',nc3d
          print *,sname,'npccn= ',npccn
          print *,sname,'qc3d  = ',qc3d
          print *,sname,'mpccn = ',mpccn
        endif
c
c          print *,sname,'sw    = ',hugh_make_supw(pp3d,tk3d,qv3d)*1.0d2
c          print *,sname,'si    = ',hugh_make_supi(pp3d,tk3d,qv3d)*1.0d2
c
      la=.NOT.lcheck
c
      END FUNCTION beheng_make_drop_activation
C*****************************************************************************
