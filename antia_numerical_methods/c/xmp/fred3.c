/*	To solve eigenvalue problem for linear Fredholm equation using quadrature method */
...
/*	Nonzero function to supply initial guess for eigenfunction */
