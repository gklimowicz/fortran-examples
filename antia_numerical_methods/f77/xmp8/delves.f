...
!	If NZ turns out to be very large no zeros are determined but
!	the write statement may give error trying to write nonexistent
!	numbers. This can happen if one of the zero falls very close
!	to the circle.
