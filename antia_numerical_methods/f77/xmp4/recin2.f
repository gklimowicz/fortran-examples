!     PROGRAM FOR RECURSIVE EVALUATION OF DOUBLE INTEGRAL
!     ADPIN1 AND KRONR1 ARE COPIES OF ADPINT AND KRONRD RESPECTIVELY
...
51    FORMAT('  IER =',I4,4X,'NO. OF FUNCTION EVALUATIONS =',I8,4X,
     1 'INTEGRAL =',1PE14.6/5X,'ESTIMATED ERROR =',E14.6,5X,
     2 'EXACT VALUE =',E14.6)
...
!     THE EXACT VALUE OF INTEGRAL=PI(1-1/SQRT(2))

      REXCT=4.*ATAN(1.0)*(1.-1./SQRT(2.0))
...
!     THE REQUIRED INTEGRAND IS THE INTEGRAL OVER Y DIRECTION
...
!     STORE THE VALUE OF X IN THE COMMON BLOCK FOR USE BY F1
      XX=X
...
!     ACCUMULATE THE NO. OF FUNCTION EVALUATIONS
      NP=NP+NPT
      END
...
!     THE VALUES OF X IS TAKEN FROM THE COMMON BLOCK
