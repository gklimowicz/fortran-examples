...
52    FORMAT(10F8.3)
53    FORMAT('   IER =',I4,5X,'IFLG =',I2,5X,'EIGENVALUE =',1PE14.6/
     1       5X,'RAYLEIGH QUOTIENT =',E14.6,5X,'FINAL SHIFT =',E14.6)
54    FORMAT('  EIGENVECTOR =',1P4E14.6/(2X,4E14.6))
55    FORMAT('   INITIAL SHIFT =',1P2E14.6)
56    FORMAT('  LEFT EIGENVECTOR =',1P4E14.6/(2X,4E14.6))
