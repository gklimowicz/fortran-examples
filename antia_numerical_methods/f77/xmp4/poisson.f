...
51    FORMAT(I5,1P5E13.5)
52    FORMAT('    I    PROB(I) ')
53    FORMAT(/,'  Mean =',1PE13.5,'   Chi-square = ',E13.5,
...
54    FORMAT(' Probability of finding a value of CHI or larger =',
     1               1PE12.3)
      ...
      RN=1E4
      NUM=RN
100   PRINT *,' TYPE RMU = Mean of the Poisson distribution (>0,<100)'
      READ *,RMU
!       Larger value of RMU may give underflow
      IF(RMU.GT.100.OR.RMU.LE.0) STOP
      SEED=-1
      DO I=1,200
        IP(I)=0.0
      ENDDO
...
!      IMPLICIT REAL*8(A-H,O-Z)
      ...
      PARAMETER(PI=3.14159265358979324D0,NMAX=170)

      SIG=SQRT(RMU)
      N=MAX(20E0,RMU+7*SIG)
