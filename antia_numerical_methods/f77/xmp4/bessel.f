...
51    FORMAT('   X =',1PE14.6,5X,'N =',I4,5X,'J0(X) =',E14.6,5X,
     1       'J1(X) =',E14.6)
52    FORMAT('   BJN:   J0(X) =',1PE14.6,5X,'J1(X) =',E14.6,5X,
     1       'JN(X) =',E14.6)
53    FORMAT('   BJY0:   J0(X) =',1PE14.6,5X,'Y0(X) =',E14.6)
54    FORMAT('   BJY1:   J1(X) =',1PE14.6,5X,'Y1(X) =',E14.6)
55    FORMAT(5X,'Y0(X) =',1PE14.6,5X,'Y1(X) =',E14.6)
56    FORMAT('   BYN:   Y0(X) =',1PE14.6,5X,'Y1(X) =',E14.6,5X,
     1       'YN(X) =',E14.6)
57    FORMAT('   SPHBJN:   j0(X) =',1PE14.6,5X,'j1(X) =',E14.6,5X,
     1       'jN(X) =',E14.6)
58    FORMAT(5X,'I0(X) =',1PE14.6,5X,'I1(X) =',E14.6)
59    FORMAT('   BIN:   I0(X) =',1PE14.6,5X,'I1(X) =',E14.6,5X,
     1       'IN(X) =',E14.6)
60    FORMAT(5X,'K0(X) =',1PE14.6,5X,'K1(X) =',E14.6)
61    FORMAT('   BKN:   K0(X) =',1PE14.6,5X,'K1(X) =',E14.6,5X,
     1       'KN(X) =',E14.6)
...
51    FORMAT('  BJN FAILED AT N =',I6,'  X =',1PE13.5,'  S =',E13.5)
...
51    FORMAT('  BIN FAILED AT N =',I6,'  X =',1PE13.5,'  S =',E13.5)
