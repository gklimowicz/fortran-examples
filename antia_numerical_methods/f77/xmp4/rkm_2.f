...
!     EQUATIONS USING SECOND ORDER RUNGE-KUTTA METHOD WITH ADAPTIVE
!     STEP SIZE CONTROL
...
51    FORMAT('   IER =',I4,5X,'T =',1PE14.6,5X,'NO. OF STEPS =',I7/
     1      5X,'STEP LENGTH =',E14.6,5X,'SOLUTION =',2E14.6/(2X,5E14.6))
52    FORMAT('    INITIAL VALUES =',1P4E14.6/(2X,5E14.6))
53    FORMAT('   LAMDA =',1PE13.5,4X,'INITIAL STEP SIZE =',E13.5,4X,
     1       'T0 =',E13.5)
