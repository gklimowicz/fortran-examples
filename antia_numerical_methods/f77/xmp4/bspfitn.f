...
!      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION T(9000),B(10000),VX(90*90,10)
...
!	EXERCISE  10.70
      ...
      FUN(XX,Y,Z)=SIN(XX)*SIN(Y)*SIN(Z)+1.D-3*RANGAU(SEED)
...
51    FORMAT('   IER =',I4,3X,'NO. OF POINTS =',I5,3X,'NO. OF KNOTS =',
     ...
     4       'IT =',I3)
52    FORMAT('   IER =',I4,3X,'X =',1P3E14.6,5X,'F(X) =',E14.6)
53    FORMAT('   EXACT VALUE :   F(X) =',1PE14.6)
