...
51    FORMAT(I5,2X,1PE14.6,2X,2E14.6,2X,2E14.6)
52    FORMAT('   IER =',I4,5X,'NO. OF PTS =',I5/
     1    5X,'EIGENVALUE =',1P2E14.6,5X,'CORRECTED EIGENVALUE =',2E14.6/
     2    13X,1HT,18X,'EIGENFUNCTION')
53    FORMAT('   CSQ =',1P2E14.6,5X,'M =',2E14.6/5X,'E0 =',2E14.6)
