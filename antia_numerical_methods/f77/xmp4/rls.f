...
51    FORMAT(I6,1P9E14.6)
52    FORMAT('  IER =',I4,5X,'CHI SQUARE =',1PE12.4,3X,
     1       'REGULARISATION TERM =',E12.4/2X,'COEFFICIENTS :',5E14.6
     2       /(5E14.6))
53    FORMAT('   NO. OF POINTS IN KERNEL =',I5,5X,
     1       'NO. OF DATA POINTS =',I5)
54    FORMAT('   ORDER OF B-SPLINES =',I3,5X,'NO. OF KNOTS =',I4,5X,
     1       'IFLG =',I2/5X,'REGULARISATION PARAMETER =',1PE14.6,5X,
