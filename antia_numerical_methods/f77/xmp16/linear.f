...
!	The iterative refinement is unlikely to converge unless the
!	residuals are calculated using higher precision, which may not
!	be possible with REAL*16 arithmetic.
!
!	N : (input) Number of equations to be solved
!	NUM : (input) Number of different sets (each with N equations) of
!	         equations to be solved
