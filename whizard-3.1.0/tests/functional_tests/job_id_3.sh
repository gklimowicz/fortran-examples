...
if test -f OCAML_FLAG; then
    ...
    ls ${script}_x.*/${script}_lib.f90 >> $script.log
    ls ${script}_x.*/${script}_lib.la >> $script.log
    ls ${script}_x.*/${script}_lib.makefile >> $script.log
    ls ${script}_x.*/${script}_x_i1.f90 >> $script.log
    ls ${script}_x.*/${script}_x_i1.lo >> $script.log
