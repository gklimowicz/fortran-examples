...
dnl Synopsis:
dnl
dnl  WO_ROOT_PATH([MINIMUM-VERSION, [ACTION-IF-FOUND, [ACTION-IF-NOT-FOUND]]])
dnl
dnl Some examples: 
dnl 
dnl    WO_ROOT_PATH(3.03/05, , AC_MSG_ERROR(Your ROOT version is too old))
dnl    WO_ROOT_PATH(, AC_DEFUN(HAVE_ROOT))
dnl 
