...
51    FORMAT('   IER =',I4,5X,'NO. OF EIGENVALUES FOUND =',I3/
     1    '    EIGENVALUES =',1P2E14.6,2X,2E14.6/(5X,2E14.6,2X,2E14.6))
52    FORMAT('    EIGENVECTORS')
53    FORMAT(I5,2X,1P2E14.6,2X,2E14.6/(7X,2E14.6,2X,2E14.6))
...
!     SUBROUTINE MATRIX.
      ...
      N=3
      PRINT *,'TYPE NUM=NO. OF EIGENVALUES'
      READ *,NUM
      NZ=0
...
!       PERTURB THE EIGENVALUE SLIGHTLY TO ENSURE THAT THE MATRIX IS NOT SINGULAR
        CALL MATRIX(CM,LC,CZERO(J)+1.E-6)
        IFLG=0
