...
51    FORMAT('    IER =',I4,5X,'NUSE =',I4,5X,'XB =',1PE14.6)
52    FORMAT('   POLYNOMIAL INTERPOLATION USING 1,...,',I2,' POINTS'/
     1       (1P5E14.6))
53    FORMAT(5X,8HF'(XB) =,1PE14.6,5X,9HF''(XB) =,E14.6)
54    FORMAT(5X,'IER =',I4,5X,'CUBIC SPLINE COEFFICIENTS'/(1P3E14.6))
55    FORMAT('   CUBIC SPLINE INTERPOLATION AT XB  =',1PE14.6,5X,
     1       'IER =',I4/3X,'F(XB) =',E14.6,4X,8HF'(XB) =,E14.6,4X,
     2        9HF''(XB) =,E14.6) 
56    FORMAT('   RATIONAL FUNCTION INTERPOLATION USING ',I2,
     1       ' POINTS',5X,'IER =',I4/7X,'F(',1PE14.6,') =',E14.6)
57    FORMAT('    IER =',I4,5X,'K =',I3,5X,'B-SPLINE COEFFICIENTS'/
     1       (1P5E14.6))
58    FORMAT('   B-SPLINE INTERPOLATION WITH K =',I4,' AT XB  =',
     1  1PE14.6,5X,'IER =',I4/3X,'F(XB) =',E14.6,4X,8HF'(XB) =,E14.6,4X,
     2        9HF''(XB) =,E14.6) 
