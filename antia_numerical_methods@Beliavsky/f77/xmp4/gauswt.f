...
!	This routine doesn't give proper results for 8 point Gaussian
!	formula using single precision arithmeric.
...
!	It is not advisable to use this subroutine in single precision
!	for calculating Gaussian formulas, except for those involving
!	very small number of abscissas.
!
