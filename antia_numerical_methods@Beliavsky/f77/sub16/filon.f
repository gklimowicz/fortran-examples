...
!	THC should be about (100*hcross)**(1/6)
      PARAMETER(NMIN=5,NMAX=15,THC=5.Q-6)
!      PARAMETER(NMIN=3,NMAX=15,THC=0.005D0)
...
!	Use Taylor series expansion
          ...
          BETA=2.Q0/3.+2.*T*T*(1.Q0/15.+T*T*(-2.Q0/105.+T*T/567.))
          GAMMA=4.Q0/3.+T*T*(-2.Q0/15.+T*T*(1.Q0/210.-T*T/11340.))
        ENDIF
